...
$downloadfile = 'TBGroup_' . date("ymdHi");
?>
    ...
    <div class="main">
        <div class="headernav">
            ...
            <div style="position:relative; margin-left:10px; margin-top:10px;">
                <form class="form" method='post' target="_blank" action='<?php echo base_url() ?>index.php/TBReportController/show'>
                    <b style="margin-right:20px">Groupwise Trial Balance</b>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                var reporttitle = 'TBGroup Report from ' + fromYear + ' To ' + toYear;
                CoName = CoName.replace(/%20/g, " ");
                ...
                $('#example').DataTable({
                    ...
                    footerCallback: function(row, data, start, end, display) {
                        ...
                        while (j < nb_cols) {
                            ...
                            // Update footer
                            // $(api.column(j).footer()).html(pageTotal.toFixed(2) + '<hr> <br>' + pageTotal1.toFixed(2));
