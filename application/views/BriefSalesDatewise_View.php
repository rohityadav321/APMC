...
$downloadfile = 'BriefSalesDateWise_' . date("ymdHi");
?>


<head>
    <title>Brief Sales Report Datewise</title>
...
<body>
    <div class="main">
        <div class="headernav">
            <div style="position:relative; margin-left:10px; margin-top:10px;" 0><b>Brief Sales Report</b></div>
            <?php
            ...
            ?>
            <form method='post' action='<?php echo base_url() ?>index.php/SalesController/BriefsalesDatewiseFilter'>
                <label style="position:absolute;font-size:15px;margin-left:170px;margin-top:-23px;">From : </label>
                <input style="position:absolute;margin-left:220px;margin-top:-30px;" type="date" id="fromYear" name="fromYear" value="<?php echo $fromyear; ?>">

                <label style="position:absolute;font-size:15px;margin-left:400px;margin-top:-23px;">To : </label>
                <input style="position:absolute;margin-left:430px;margin-top:-30px;" type="date" id="toYear" name="toYear" value="<?php echo $toyear; ?>">
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var reporttitle = 'BriefSales DateWise Report from ' + fromYear + ' To ' + toYear;
