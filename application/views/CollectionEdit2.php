...
echo form_open("CollectionController/EditTry2/".$id."/".$idnumber,$attributes);
?>
   ...
   <head>
      ...
      <script type="text/javascript">
        ...
        function calculateVatavAmt()
        {
          ...
          {
            document.getElementById("VatavRate").value = document.getElementsByName("VatavRate")[0].placeholder;
        ...
        function calculateBrokAmt()
        {
            ...
            {
              document.getElementById("BrokRate").value = document.getElementsByName("BrokRate")[0].placeholder;
        ...
        function calculateIntAmt()
        {
            ...
            {
              document.getElementById("IntRate").value = document.getElementsByName("IntRate")[0].placeholder;
        ...
        function calculateFeeAmt()
        {
            ...
            {
              document.getElementById("LFeeRate").value = document.getElementsByName("LFeeRate")[0].placeholder;
        ...
        function calculateMode()
        {
          ...
          {
            // alert(document.getElementsByName("Chithi")[0].placeholder);
            document.getElementById("Chithi").value = document.getElementsByName("Chithi")[0].placeholder;
          }
        ...
        function calculateCheque()
        {
            ...
            // $Edit_Details[0]->ChequeAmt
            var cheq = <?php echo $Edit_Details[0]->ChequeAmt ; ?> +
                      <?php echo $Edit_Details[0]->CashAmt ; ?> +
                      <?php echo $Edit_Details[0]->KasarAmt ; ?> +
                        <?php echo ($Edit_Details[0]->BillAmt -$Edit_Details[0]->RcptAmt) ; ?> +
                          <?php echo $Edit_Details[0]->VatavAmt ; ?> +
                          <?php echo $Edit_Details[0]->BrokAmt ; ?> -
                          <?php echo $Edit_Details[0]->IntAmt ; ?> -
                          <?php echo $Edit_Details[0]->LFeeAmt ; ?> -
                          <?php echo $Edit_Details[0]->Chithi ; ?> -
                        parseFloat(document.getElementById("BalanceDue").value) - 
        ...
        function checkMode()
        {
          ...
          else if(mode == "O")
          {
            ...
            document.getElementById("ChequeAmt").style.pointerEvents = "auto";
            // document.getElementById("ChequeAmt").disabled = false;
            document.getElementById("CashAmt").style.opacity = 1;
            document.getElementById("ChequeAmt").style.opacity = 1;
          }
        ...
        function calculateBalance()
        {
          ...
          var bal = parseFloat(document.getElementById("ChequeAmt").value) + 
                      parseFloat(document.getElementById("CashAmt").value) + 
                      parseFloat(document.getElementById("KasarAmt").value);
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <td><input
                              ...
                              value="<?php echo set_value('DebtorCode', $Edit_Details[0]->DebtorCode); ?>">
                    ...
                    <td colspan="2"><input
                              ...
                              value="<?php echo set_value('DebtorName',$Edit_Details[0]->DebtorName); ?>">
                   ...
                   <tr>
                    ...
                    <td><input
                              ...
                              value="<?php echo set_value('BrokerCode', $Edit_Details[0]->CustomerCode); ?>"></td>
                    <td colspan="2">
                      <input
                              style="width: 100%"
                              type="text"
                              ...
                              value="<?php echo set_value('BrokerCode', $Edit_Details[0]->CustomerName); ?>">
                            </td>
                            <!-- <td><input
                              type="text"
                              id=""
                   ...
                   <tr>
                    ...
                    <td><input
                              ...
                              value="<?php echo set_value('BrokerCode', $Edit_Details[0]->BrokerCode); ?>">
                    ...
                    <td colspan="2"><input
                              ...
                              value="<?php echo set_value('BrokerCode', $Edit_Details[0]->BrokerTitle); ?>">
                            </td>
                  ...
                  <tr>
                    ...
                    <td><input
                              ...
                              name="RcptAmt"
                              placeholder="RcptAmt"
                              value="<?php echo set_value('RcptAmt', $Edit_Details[0]->RcptAmt); ?>">
                  ...
                  <tr>
                    ...
                    <td><input
                              ...
                              name="BillAmt"
                              placeholder="BillAmt"
                            value="<?php echo set_value('BillAmt', $Edit_Details[0]->BillAmt); ?>"
                    >
                    ...
                    <input
                              ...
                              value="<?php echo set_value('BillDate', $Edit_Details[0]->BillDate); ?>"
                    readonly>
                  ...
                  <tr>
                    ...
                    <td><input
                              ...
                              id="SettledAmt"
                              name="SettledAmt"
                              value="<?php echo set_value('SettledAmt', $Edit_Details[0]->RcptAmt); ?>"
                    ...
                    placeholder="ItemAmt"
                    name="ItemAmt"
                    value="<?php echo set_value('ItemAmt', $Edit_Details[0]->ItemAmt); ?>"
                    >
                    <span class="text-danger"><?php echo form_error('ItemAmt'); ?></span></td>
                    <td></td>
                  ...
                  <tr>
                    ...
                    <td><input
                              ...
                              id="BalanceDue"
                              name="BalanceDue"
                              value="<?php echo set_value('BalanceDue', ($Edit_Details[0]->BillAmt -$Edit_Details[0]->RcptAmt)); ?>"
        ...
        <tbody>
          ...
          <tr>
            ...
            <div class="row" style="margin-left: 10px">
              <table>
                <tr>
                  ...
                  <td><input
                              ...
                              name="IDNumber"
                              readonly
                              value="<?php echo set_value('IDNumber', $ItemList[0]->IDNumber); ?>">
                ...
                <tr>
                  ...
                  <td><input
                              ...
                              value="<?php echo set_value('CollectDate', $Edit_Details[0]->CollectDate); ?>">
                ...
                <tr>
                  <td>Mode</td>
                  <td><select class="btn btn-primary dropdown-toggle" onkeydown="focusnext(event)" id="Mode" name="Mode" onchange="checkMode()" value="<?php echo set_value('Mode', $Edit_Details[0]->Mode); ?>">

                          <option value="C" <?php if($Edit_Details[0]->Mode=="C") echo 'selected="selected"'; ?>>Cash</option>
                          <option value="B" <?php if($Edit_Details[0]->Mode=="B") echo 'selected="selected"'; ?>>Bank</option>
                          <option value="O" <?php if($Edit_Details[0]->Mode=="O") echo 'selected="selected"'; ?>>Both</option>
              ...
              <a type="button" accesskey="n" style="float: right; height: 30px; margin-left: 650px" class="btn btn-primary" data-toggle="modal" data-target="#E1Modal" id= "ChargesNarration">Charges And Narration (Alt+N)</a>
            </div>
          </div>
               ...
               <table class="table tableData1">
                  <thead>
                   ...
                   <tbody>
                        <tr>
                          <td >
                    <a type="button" class="btn btn-info" data-toggle="modal" data-target="#BillModal" style="opacity: 0.6;pointer-events: none;">
                    ...
                    name="BillNo"
                    value="<?php echo set_value('BillNo', $Edit_Details[0]->BillNo); ?>"
                    readonly>
                ...
                <td><input type="text" 
                    ...
                    onkeydown="focusnext(event)"
                    name="LDays"
                    value="<?php echo set_value('LDays', $Edit_Details[0]->LDays); ?>"
                    readonly>
                ...
                <td><input type="text" 
                    class="form-control"
                    id="VatavRate"
                    placeholder="<?php echo set_value('VatavRate', $Edit_Details[0]->VatavRate); ?>"
                    name="VatavRate"
                    onkeydown="focusnext(event)"
                ...
                <td><input type="text" 
                    class="form-control"
                    id="VatavAmt"
                    placeholder="VatavAmt"
                    name="VatavAmt"
                    onkeydown="focusnext(event)"
                    onfocus="this.select();"
                    value="<?php echo set_value('VatavAmt', $Edit_Details[0]->VatavAmt); ?>"
                    >
                ...
                <td><input type="text" 
                    class="form-control"
                    id="BrokRate"
                    placeholder="<?php echo set_value('BrokRate', $Edit_Details[0]->BrokRate); ?>"
                    name="BrokRate"
                    onkeydown="focusnext(event)"
                ...
                <td><input type="text" 
                    ...
                    onkeydown="focusnext(event)"
                    onfocus="this.select();"
                    value="<?php echo set_value('BrokAmt', $Edit_Details[0]->BrokAmt); ?>"
                    >
                ...
                <td><input type="text" 
                    ...
                    id="IntRate"
                    onkeydown="focusnext(event)"
                    placeholder="<?php echo set_value('IntRate', $Edit_Details[0]->IntRate); ?>"
                    name="IntRate"
                ...
                <td><input type="text" 
                    ...
                    onkeydown="focusnext(event)"
                    onfocus="this.select();"
                    value="<?php echo set_value('IntAmt', $Edit_Details[0]->IntAmt); ?>"
                    >
                ...
                <td><input type="text" 
                    class="form-control"
                    id="LFeeRate"
                    placeholder="<?php echo set_value('LFeeRate', $Edit_Details[0]->LFeeRate); ?>"
                    name="LFeeRate"
                    onkeydown="focusnext(event)"
                ...
                <td><input type="text" 
                    ...
                    onkeydown="focusnext(event)"
                    onfocus="this.select();"
                    value="<?php echo set_value('LFeeAmt', $Edit_Details[0]->LFeeAmt); ?>"
                    >
                ...
                <td><input type="text" 
                    class="form-control"
                    id="Chithi"
                    placeholder="<?php echo set_value('Chithi', $Edit_Details[0]->Chithi); ?>"
                    name="Chithi"
                    onkeydown="focusnext(event)"
                ...
                <td><input type="text" 
                    class="form-control"
                    id="ChequeAmt"
                    placeholder="<?php echo set_value('ChequeAmt', $Edit_Details[0]->ChequeAmt); ?>"
                    name="ChequeAmt"
                    onkeydown="focusnext(event)"
                ...
                <td><input type="text" 
                    class="form-control"
                    id="CashAmt"
                    placeholder="<?php echo set_value('CashAmt', $Edit_Details[0]->CashAmt); ?>"
                ...
                <td><input type="text" 
                    class="form-control"
                    id="KasarAmt"
                    placeholder="<?php echo set_value('KasarAmt', $Edit_Details[0]->KasarAmt); ?>"
                    onkeydown="focusnext(event)"
                    name="KasarAmt"
                ...
                <td>
                  <input style="float: right;width: 15px;padding:1px;background-color:blue;border-color:blue;" 
                      class="btn btn-success mr-2" accesskey="s" type="submit" name="Save" id="Save" value="U">
                </td>
         ...
         <div class="row">
            ...
            <tr>
              ...
              <td><?php echo $TableData[$i]->BrokAmt;?></td>
                ...
                <tr>
        <td>Totals : </td>
            <td><?php echo $Totals[0]->BillCount;?></td>
           <td colspan="2"></td>
            <td><?php echo $Totals[0]->VatavAmt;?></td>
            <td></td>
            <td><?php echo $Totals[0]->BrokAmt;?></td>
      ...
      <div class="modal-content">
          ...
          <div class="form-group row">
                <label class="control-label col-sm-2" for="broker">Receipt No.</label>
                 <div class="col-sm-2">
                    ...
                    name="ReceiptNo"
                    readonly
                    value="<?php echo set_value('ReceiptNo', $TableData[0]->IDNumber); ?>">
                  ...
                  <div class="col-sm-2">
                    ...
                    placeholder="SlipNo"
                    name="SlipNo"
                    onkeydown="focusNextBox(event)"
                    value="<?php echo set_value('SlipNo', $ItemList[0]->SlipNo); ?>">
        ...
        <div class="form-group row">
                  ...
                  <div class="col-sm-2">
                    ...
                    placeholder=""
                    name="CashCode"
                    value="<?php echo set_value('CashCode', $ItemList[0]->CashCode); ?>"
                    onfocus="this.select();">
                  ...
                  <div class="col-sm-3">
                    ...
                    placeholder=""
                    name="CashTitle"
                    value="<?php echo set_value('CashTitle', $ItemList[0]->CashTitle); ?>"
                    onfocus="this.select();">
        ...
        <div class="form-group row">
                <label class="control-label col-sm-2" for="broker">Cheque Amt.</label>
                  ...
                  <div class="col-sm-2">
                    ...
                    onkeydown="focusNextBox(event)"
                    name="DepBankCode"
                    value="<?php echo set_value('DepBankCode', $ItemList[0]->DepBankCode); ?>"
                    onfocus="this.select();">
                  ...
                  <div class="col-sm-3">
                    ...
                    placeholder=""
                    name="DepBankName"
                    value="<?php echo set_value('DepBankName', $ItemList[0]->DepBankTitle); ?>"
                    onfocus="this.select();">
        ...
        <div class="form-group row">
                  ...
                  <div class="col-sm-2">
                    ...
                    onkeydown="focusNextBox(event)"
                    name="CheqNo"
                    value="<?php echo set_value('CheqNo', $ItemList[0]->CheqNo); ?>"
                    onfocus="this.select();">
                  ...
                  <div class="col-sm-4">
                    ...
                    onkeydown="focusNextBox(event)"
                    name="UTRNo"
                    value="<?php echo set_value('UTRNo', $ItemList[0]->UTRNo); ?>"
                    onfocus="this.select();">
        ...
        <div class="form-group row">
                  ...
                  <div class="col-sm-2">
                    ...
                    name="CheqBankCode"
                    value="<?php echo set_value('CheqBankCode', $ItemList[0]->CheqBankCode); ?>"
                    onfocus="this.select();">
                  ...
                  <div class="col-sm-4">
                    ...
                    placeholder=""
                    name="CheqBankName"
                    value="<?php echo set_value('CheqBankName',$ItemList[0]->CheqBankTitle); ?>"
                    onfocus="this.select();">
        ...
        <div class="form-group row">
                  ...
                  <div class="col-sm-2">
                    ...
                    onkeydown="focusNextBox(event)"
                    name="TrCode"
                    value="<?php echo set_value('TrCode', $ItemList[0]->TrCode); ?>"
                    onfocus="this.select();">
                  ...
                  <div class="col-sm-3">
                    ...
                    name="ChqDate"
                    onkeydown="focusNextBox(event)"
                    value="<?php echo $ItemList[0]->ChqDate == '' ? set_value('ChqDate', date_format(date_create($ItemList[0]->ChqDate),"Y-m-d")) : set_value('ChqDate',$today); ?>"
                    onfocus="this.select();">
        ...
        <!-- <div class="form-group row">
                  <label hidden class="control-label col-sm-2" for="broker">Cash Amt.</label>
                  <div class="col-sm-2">
                    <input hidden
                    type="text" 
                    class="form-control blue"
                  ...
                  <label hidden class="control-label col-sm-2" for="broker">Cheque Amt.</label>
                  <div class="col-sm-2">
                    <input hiddden 
                    type="text" 
                    class="form-control blue"
        ...
        <div class="control-label col-sm-2" style="position: absolute;right:5px;">
          ...
          <div class="form-group row" hidden>
                  ...
                  <div class="col-sm-2">
                    ...
                    name="ReturnAmt"
                    value="<?php echo set_value('ReturnAmt', $ItemList[0]->ReturnAmt); ?>">
