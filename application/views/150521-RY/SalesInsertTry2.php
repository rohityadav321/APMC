...
echo form_open("SalesController/InsertDetailTry/" . $Loaded_List[0]->BillNo, $attributes);
?>
...
<head>
  ...
  <script type="text/javascript">
    ...
    function calculateCGST() {
      var cgstAmt = (document.getElementById("TaxableAmt").value * document.getElementById("CGSTAmt").value) / 100;
      document.getElementById("CGSTAmt").value = cgstAmt.toFixed(2);
    }

    function calculateSGST() {
      var sgstAmt = (document.getElementById("TaxableAmt").value * document.getElementById("SGSTAmt").value) / 100;
...
<body>
  <div class="container-fluid">
    <div class="card border-dark">
      <div class="card-header border-dark">
        <!-- <h5>Collection</h5> -->
        <center>
          <a style="float: right;" id="cancel" accesskey="c" class="btn btn-danger" href="<?php echo base_url() . "index.php/SalesController/DeleteSales/" . $Loaded_List[0]->BillNo; ?>" tabindex="-1">
            Cancel (Alt+C)
          </a>

          <!-- <input style="float: right;" type="reset" accesskey="x" class="btn btn-danger mr-2" 
                                      name="Cancel" value="Clear(Alt+X)"> -->
          <!-- vnv 170421                                      
                            <a style="float: right;" class="btn btn-success mr-2" href="<?php echo base_url() ?>index.php/SalesController/show/" tabindex="-1">Save</a>

                            <a style="float: right;" class="btn btn-info mr-2" data-toggle="modal" href="#TableModalForm" tabindex="-1">Totals</a>
 -->
          <!-- added by BP last changes 170421                                        -->
          <a style="float: right;" class="btn btn-success mr-2" href="<?php echo base_url() ?>index.php/SalesController/show/" tabindex="-1">Go Back</a>

          <a style="float: right;" class="btn btn-info mr-2" data-toggle="modal" href="#TableModalForm" tabindex="-1" accesskey="s">Save (Alt+S)</a>
          <!-- added upto here by BP last changes 170421                              -->
          ...
          <!-- href="<?php echo base_url() . "index.php/SalesController/getInvoiceData/" . $Loaded_List[0]->BillNo; ?>" > -->


          <!-- <input style="float: right;" class="btn btn-success mr-2" accesskey="s" 
                                      type="submit" name="Save" id="Save" value="Add(Alt+A)"> -->
          &nbsp;
          <?php
            ...
            <div class="card" style="background: #a6b6e0;margin-left: 10px">
              <table>
                <tr>
                  ...
                  <td class="firstTable">
                    <input class="col-sm-5" type="text" id="BillNo" value="<?php echo set_value('BillNo', $Loaded_List[0]->BillNo); ?>" name="BillNo" placeholder="BillNo" readonly tabindex="-1">
                  </td>
                </tr>

                <tr>
                  <td class="firstTable">Bill Date</td>
                  <td class="firstTable"><input type="date" id="BillDate" name="BillDate" value="<?php echo set_value('BillDate', $Loaded_List[0]->BillDate); ?>" placeholder="BillDate" readonly tabindex="-1">
                  </td>
                </tr>

                <tr>
                  <td class="firstTable textBlue">
                    Godown
                  ...
                  <td class="firstTable" colspan="4">
                    <input class="col-sm-2" type="text" id="GodownID" value="<?php echo set_value('GodownID', $Loaded_List[0]->GodownID); ?>" name="GodownID" placeholder="GodownID" readonly tabindex="-1">
                    ...
                    &nbsp;&nbsp;
                    <input class="col-sm-5" type="text" id="GodownTitle" value="<?php echo set_value('GodownDesc', $Loaded_List[0]->GodownDesc); ?>" name="GodownTitle" placeholder="GodownTitle" readonly tabindex="-1">
                  </td>
                  <td>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td class="firstTable" colspan="2"><input style="width: 95%" type="text" id="LRNo" name="LRNo" value="<?php echo set_value('LRNo', $Loaded_List[0]->LRNo); ?>" readonly placeholder="LRNo" tabindex="-1">
                ...
                <tr>
                  ...
                  <td class="firstTable"><input type="text" class="col-sm-5" id="MudiBazar" value="<?php echo set_value('MudiBazar', $Loaded_List[0]->MudiBazar); ?>" name="MudiBazar" readonly placeholder="Y" tabindex="-1">
                    <span class="text-danger"><?php echo form_error('MudiBazar'); ?></span>
                  </td>

                  <td class="firstTable">Eway Bill No.</td>
                  <td class="firstTable"><input type="text" id="EWayBillNo" name="EWayBillNo" value="<?php echo set_value('EWayBillNo', $Loaded_List[0]->EWayBillNo); ?>" placeholder="EWayBillNo" readonly tabindex="-1">
                ...
                <tr>
                  ...
                  <td class="firstTable">
                    <input id="DeliDate" value="<?php echo set_value('DeliDate', date('d-m-Y', strtotime($Loaded_List[0]->DeliDate))); ?>" name="DeliDate" readonly tabindex="-1">
              ...
              <table>
                <tr>
                  ...
                  <td class="firstTable" colspan="3">
                    <input class="col-sm-2" type="text" id="DebtorID" value="<?php echo set_value('DebtorID', $Loaded_List[0]->DebtorID); ?>" name="DebtorID" placeholder="DebtorID" readonly tabindex="-1">
                    <span class="text-danger"><?php echo form_error('DebtorID'); ?></span>

                    <input type="text" style="width: 55%" id="DebtorTitle" name="DebtorTitle" placeholder="Debtor name" value="<?php echo set_value('DebtorTitle', $DebtorID[0]->ACTitle); ?>" readonly tabindex="-1">
                  </td>
                ...
                <tr>
                  ...
                  <td class="firstTable" colspan="3">
                    ...
                    <input class="col-sm-2" type="text" id="PartyCode" name="PartyCode" value="<?php echo set_value('PartyCode', $Loaded_List[0]->PartyCode); ?>" readonly placeholder="Code" tabindex="-1">
                    <span class="text-danger"><?php echo form_error('PartyCode'); ?></span>

                    <input type="text" id="CPName" style="width: 55%" value="<?php echo set_value('CPName', $Loaded_List[0]->CPName); ?>" name="CPName" placeholder="Party Name" readonly tabindex="-1">
                ...
                <tr>
                  ...
                  <td class="firstTable"><input type="text" id="Area" name="Area" value="<?php echo set_value('Area', $Loaded_List[0]->Area); ?>" placeholder="Area" readonly tabindex="-1">
                    <span class="text-danger"><?php echo form_error('Area'); ?></span>
                  </td>

                  <td class="firstTable" colspan="2">Sale Type
                    <input type="text" id="SaleType" value="<?php echo set_value('SaleType', $Loaded_List[0]->SaleType); ?>" name="SaleType" placeholder="SaleType" readonly tabindex="-1">
                ...
                <tr>
                  ...
                  <td class="firstTable" colspan="3">
                    <input class="col-sm-2" type="text" id="BrokerID" value="<?php echo set_value('BrokerID', $Loaded_List[0]->BrokerID); ?>" name="BrokerID" placeholder="BrokerID" readonly tabindex="-1">
                    <span class="text-danger"><?php echo form_error('BrokerID'); ?></span>

                    <input type="text" style="width: 48%" id="BrokerTitle" name="BrokerTitle" value="<?php echo set_value('BrokerTitle', $Loaded_List[0]->BrokerTitle); ?>" placeholder="BrokerTitle" readonly tabindex="-1">
                ...
                <tr>
                  ...
                  <td class="firstTable"><input type="text" id="SalesMan" name="SalesMan" placeholder="SalesMan" readonly tabindex="-1">
                  </td>
                </tr>

                <tr>
                  <td class="firstTable">Hel/Majuri</td>
                  <td class="firstTable"><input type="text" id="HelMajuri" value="<?php echo set_value('HelMajuri', $Loaded_List[0]->HelMajuri); ?>" name="HelMajuri" placeholder="Hel/Majuri" readonly tabindex="-1">
                    <span class="text-danger"><?php echo form_error('HelMajuri'); ?></span>
                  </td>
                  <td class="firstTable">Other charges/ Disc.</td>
                  <td class="firstTable"><input type="text" id="OtherChrgs" value="<?php echo set_value('OtherChrgs', $Loaded_List[0]->OtherChrgs); ?>" name="OtherChrgs" placeholder="OtherChrgs" readonly tabindex="-1">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <input oninput="this.value = this.value.toUpperCase()" class="form-control" id="GodownI" onkeydown="focusnext(event)" name="GodownI" autofocus value="<?php echo set_value('GodownID'); ?>" placeholder="GodownI" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('GodownID'); ?></span>
                  ...
                  <td>
                    <input oninput="this.value = this.value.toUpperCase()" class="form-control" id="ItemCode" name="ItemCode" autocomplete="off" onkeydown="focusnext(event)" value="<?php echo set_value('ItemCode'); ?>" placeholder="ItemCode" onfocus="this.select();">
                  ...
                  <td>
                    <input style="height: inherit;" type="text" class="form-control" id="Qty" onkeydown="focusnext(event);" name="Qty" value="<?php echo set_value('Qty'); ?>" placeholder="Qty" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('Qty'); ?></span>

                    <input type="hidden" class="form-control" id="BalQty" name="BalQty" value="<?php echo set_value('BalQty'); ?>">
                  </td>
                  ...
                  <td><input style="height:inherit;" type="text" class="form-control" id="Rate" name="Rate" onkeydown="focusnext(event)" value="<?php echo set_value('Rate'); ?>" placeholder="Rate" onfocus="this.select();">
          ...
          <div class="col-sm-12" style="padding-left: 20px; padding-right: 20px">
            <table style="width:100%;">
              <tr>
                ...
                <td colspan="2"><input type="text" readonly id="GodownDesc" name="GodownDesc" placeholder="GodownDesc" tabindex="-1">
                </td>
                ...
                <td class="firstTable"><input type="text" readonly id="Packing" name="Packing" placeholder="Packing" tabindex="-1">
                </td>

                <td class="firstTable">
                  <center>Packing Test</center>
                </td>
                <td class="firstTable"><input type="text" readonly id="PackingT" name="PackingT" placeholder="Packing Test" tabindex="-1">
                </td>

                <td class="firstTable"> &nbsp;&nbsp;&nbsp; Sale Type <input style="width: 40%" type="text" readonly id="Sale" name="Sale" placeholder="Sale " tabindex="-1"></td>


                <td class="firstTable">Rate Per <input type="text" id="RatePer" readonly value="<?php echo set_value('RatePer'); ?>" name="RatePer" placeholder="RatePer" tabindex="-1"></td>


                <td class="firstTable">
                  <center>Disc % </center>
                </td>
                <td class="firstTable"> <input style="width:30px;" type="text" id="DiscDetRate" name="DiscDetRate" onkeydown="focusnext(event)" onblur="calculateDiscount();" value="<?php echo set_value('DiscDetRate'); ?>" onfocus="this.select();">
                ...
                <td class="firstTable">
                  <input style="float: right;width: 15px;padding:1px;background-color:blue;border-color:blue;" class="btn btn-success mr-2" accesskey="a" type="submit" name="Save" id="Save" value="A" tabindex="-1">
                </td>
              </tr>
              <!--   </table> -->
          </div>
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <tr>
              ...
              <td class="firstTable" colspan="2"><input type="text" readonly id="ItemDesc" name="ItemDesc" value="<?php echo set_value('ItemDesc'); ?>" placeholder="Item Desc" tabindex="-1">
              </td>
              <!-- <td></td> -->
              ...
              <td class="firstTable"><input type="text" id="SalesCode" readonly name="SalesCode" value="<?php echo set_value('SalesCode'); ?>" placeholder="" tabindex="-1">
              </td>
              <td class="firstTable" colspan="2"><input style="width: 100%" type="text" id="SalesTitle" readonly name="SalesTitle" value="<?php echo set_value('SalesTitle'); ?>" placeholder="" tabindex="-1">
                <span class="text-danger"><?php echo form_error('SalesTitle'); ?></span>
              </td>
              <!-- <td></td> -->

              <td class="firstTable"><input type="text" id="OCommRate" name="OCommRate" readonly value="<?php echo set_value('OCommRate'); ?>" placeholder="" tabindex="-1">
                <span class="text-danger"><?php echo form_error('OCommRate'); ?></span>
              </td>

              <td class="firstTable"><input type="text" id="OCommRate1" readonly name="OCommRate1" placeholder="" tabindex="-1">
                <span class="text-danger"><?php echo form_error('OCommRate'); ?></span>
              </td>
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <tr>
              ...
              <td class="firstTable"><input type="text" id="TaxCode" name="TaxCode" readonly value="<?php echo set_value('TaxCode'); ?>" placeholder="TaxCode" tabindex="-1">
                <span class="text-danger"><?php echo form_error('TaxCode'); ?>
                </span>
              </td>

              <td class="firstTable" colspan="2"><input style="width: 100%" type="text" id="TaxTitle" readonly name="TaxTitle" value="<?php echo set_value('TaxTitle'); ?>" placeholder="TaxTitle" tabindex="-1">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  ...
                  <script type="text/javascript">
                    ...
                    var idarray = ["GodownI", "LotNo", "ItemCode", "Qty", "GrossWt", "NetWt", "Rate", "APMCIn", "ETaxIn",
                      "ContChrg", "DiscDetRate", "TCSPer", "Save"
                    ];
                      ...
                      if (e.keyCode == 13) {
                        if (document.getElementById("Qty").value != "") {
                          ...
                          if (document.getElementById("Qty").value > document.getElementById("BalQty").value) {
                            alert("Qty Entered is more than Balance i2");
                            document.getElementById("Qty").focus();
                          } else {
                            //alert(document.getElementById("Qty").value + " " + window.packingCharge);
 ...
 -->
          <a style="float: right;background-color:#3b5998;border-color:#AED6F1;" id="printInvoice" class="btn btn-success mr-2" tabindex="-1" target="_blank" accesskey="p" href="<?php echo base_url() . "index.php/SalesController/getLogoInvoiceData/" . $Loaded_List[0]->BillNo; ?>">
            <span class="glyphicon glyphicon-print"></span>
            Print Invoice (Alt+P)
          </a>
