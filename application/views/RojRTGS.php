                    ...
                    <div class="det">
                        <table>
                            <tr>
                                ...
                                <td style="width: 20%;">: <span><?php echo $Party[0]->ACCDate; ?></span></td>
                            </tr>
                            <tr>
                    ...
                    <table style="width:100%">
                        ...
                        <tr>
                            ...
                            <td rowspan="2" style="border-bottom:2px solid black;width:30%; text-align:right; ">
                                <span style="font-size: 35px;">₹</span> <span style="Padding-left:10px"><?php echo $Party[0]->ACCAmount ?></span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>: <span> <?php echo $Party[0]->ChqNo ?></span></td>
                        ...
                        <tr>
                            ...
                            <td>: <span> <?php echo $Party[0]->ACCAmount ?></span></td>
                            <td>&nbsp;</td>
