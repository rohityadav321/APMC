          ...
          $.ajax({
            ...
            success: function(result) {
              if (result == "ERROR") {
                ...
                var dataInput = result[0];
                if (result[0]['BalAmt'] == 0) {
                  // $.ajax({
                  //   url: "<?= base_url() ?>index.php/CollectionController/CheckCheqRet",
                  //   type: "post",
                  //   data: {
                  //     BillNo: BillNo
                  //   },
                  ...
                  //   success: function(result) {
                  //     console.log(result);
                  //     var check = result[0]['CheqReturn'];
                  //     if (check == "Y") {
                  //       $.ajax({
                  //         url: "<?= base_url() ?>index.php/CollectionController/GetReturnData",
                  //         type: "post",
                  //         data: {
                  //           BillNo: BillNo
                  //         },
                  ...
                  //           console.log(result);
                  //           var dataIn = result[0];
                  //           $('#DebtorCode').val(dataIn['DebtorCode']);
                  //           $('#DebtorName').val(dataIn['DebtorTitle']);
                  //           $('#Name').val(dataIn['CustomerCode']);
                  //           $('#Name1').val(dataIn['CustomerName']);
                  //           $('#BrokerCode').val(dataIn['BrokerCode']);
                  //           $('#BrokerName').val(dataIn['BrokerTitle']);
                  //           $('#BillDate').val(dataIn['BillDate']);
                  //           $('#BillAmt').val(dataIn['BillAmt']);
                  //           $('#SettledAmt').val(dataIn['AmtRecd']);
                  //           $('#RcptAmt').val(dataIn['AmtRecd']);
                  //           $('#BalanceDue').val(dataIn['BalAmt']);
                  //           $('#ItemAmt').val(dataIn['ItemAmt']);
                  //           calculateDays();
                  //         }
                  //       });
                  //     } else {
                  ...
                  $('#DebtorCode').val(dataInput['DebtorCode']);
                  $('#DebtorName').val(dataInput['DebtorTitle']);
                  $('#Name').val(dataInput['CustomerCode']);
                  $('#Name1').val(dataInput['CustomerName']);
                  $('#BrokerCode').val(dataInput['BrokerCode']);
                  $('#BrokerName').val(dataInput['BrokerTitle']);
                  $('#BillDate').val(dataInput['BillDate']);
                  $('#BillAmt').val(dataInput['BillAmt']);
                  $('#SettledAmt').val(dataInput['AmtRecd']);
                  $('#RcptAmt').val(dataInput['AmtRecd']);
                  $('#BalanceDue').val(dataInput['BalAmt']);
                  $('#ItemAmt').val(dataInput['ItemAmt']);
                  calculateDays();
          ...
          <div class="col-sm-8" id="collectionHeader">
            ...
            <table>
              ...
              <tr>
                ...
                <td colspan="2"><input class="mr-2" style="width: 100%" type="text" id="DebtorName" name="DebtorName" placeholder="DebtorName" value="<?php echo set_value('DebtorName'); ?>">
              ...
              <tr>
                <td>Name</td>
                <td><input class="mr-2" type="text" id="Name" name="Name" placeholder="CustomerCode">
                </td>
                <td colspan="2">
                  <input style="width: 100%" class="mr-2" type="text" id="Name1" name="Name1" placeholder="CustomerName">
                </td>
                <!-- <td><input
                              class="mr-2"
                              type="text"
              ...
              <tr>
                <td>Broker Name</td>
                <td><input class="mr-2" type="text" id="BrokerCode" name="BrokerCode" placeholder="BrokerCode" value="<?php echo set_value('BrokerCode'); ?>">
                  <span class="text-danger"><?php echo form_error('BrokerCode'); ?></span>
                </td>
                <td colspan="2"><input class="mr-2" style="width: 100%" type="text" id="BrokerName" name="BrokerName" placeholder="BrokerName">
                </td>
              </tr>
              ...
              <tr>
                ...
                <td colspan="2">Bill Date
                  <input id="BillDate" name="BillDate" placeholder="BillDate" value="<?php echo set_value('BillDate'); ?>">
              ...
              <tr>
                ...
                <td>SUG Gdn
                  <input style="width: 40%" type="text" id="SUG" name="SUG" placeholder="SUG">
                </td>

                <td style="padding-left: -10px">Bazar Ind<input style="width: 40%" type="text" id="Bazar" name="Bazar" placeholder="Bazar">
                </td>
                <td></td>
          ...
          <div class="row" style="margin-left: 10px">
            <div class="col-sm-6">
              <table>
                <tr>
                  <td>ID Number</td>
                  <td><input type="text" id="IDNumber" name="IDNumber" value="<?php echo $id; ?>" value="<?php echo set_value('IDNumber'); ?>" readonly>
                ...
                <tr>
                  <td>Receipt Date</td>
                  <td><input class="pink" type="date" id="CollectDate" name="CollectDate" autofocus onkeydown="focusnext(event)" onchange="calculateDays();" value="<?php echo set_value('CollectDate', $today); ?>">
              ...
              <table class="table tableData1">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type="text" class="form-control" id="BillNo" placeholder="BillNo" onkeydown="focusnext(event)" onkeypress="return event.keyCode != 13;" name="BillNo" value="<?php echo set_value('BillNo'); ?>" onfocus="this.select();">
                      <span class="text-danger"><?php echo form_error('BillNo'); ?></span>
                    </td>

                    <td><input type="text" class="form-control" id="LDays" placeholder="LDays" onkeydown="focusnext(event)" name="LDays" value="<?php echo set_value('LDays'); ?>" onfocus="this.select();">
                      <span class="text-danger"><?php echo form_error('LDays'); ?></span>
                    </td>
                    <td><input type="text" class="form-control" id="VatavRate" onkeydown="focusnext(event)" name="VatavRate" placeholder="0" onblur="calculateVatavAmt();" value="<?php echo set_value('VatavRate'); ?>" onfocus="this.select();">
                      <span class="text-danger"><?php echo form_error('VatavRate'); ?></span>
                    </td>
                    <td><input type="text" class="form-control" id="VatavAmt" name="VatavAmt" onfocus="this.select();" onkeydown="focusnext(event)" value="<?php echo set_value('VatavAmt', 0); ?>">
                      <span class="text-danger"><?php echo form_error('VatavAmt'); ?></span>
                    </td>
                    <td><input type="text" class="form-control" id="BrokRate" name="BrokRate" placeholder="0" onblur="calculateBrokAmt();" onkeydown="focusnext(event)" value="<?php echo set_value('BrokRate'); ?>" onfocus="this.select();">
                      <span class="text-danger"><?php echo form_error('BrokRate'); ?></span>
                    </td>
                    <td><input type="text" class="form-control" id="BrokAmt" name="BrokAmt" onfocus="this.select();" onkeydown="focusnext(event)" value="<?php echo set_value('BrokAmt', 0); ?>">
                      <span class="text-danger"><?php echo form_error('BrokAmt'); ?></span>
                    </td>
                    <td><input type="text" class="form-control" id="IntRate" name="IntRate" placeholder="0" onkeydown="focusnext(event)" onblur="calculateIntAmt();" value="<?php echo set_value('IntRate'); ?>" onfocus="this.select();">
                      <span class="text-danger"><?php echo form_error('IntRate'); ?></span>
                    </td>
                    <td><input type="text" class="form-control" id="IntAmt" name="IntAmt" onfocus="this.select();" onkeydown="focusnext(event)" value="<?php echo set_value('IntAmt', 0); ?>">
                    ...
                    <td><input type="text" class="form-control" id="LFeeAmt" name="LFeeAmt" onfocus="this.select();" onkeydown="focusnext(event)" value="<?php echo set_value('LFeeAmt', 0); ?>">
                    ...
                    <td><input type="text" class="form-control" id="KasarAmt" placeholder="0" onkeydown="focusnext(event)" name="KasarAmt" onblur="calculateBalance()" value="<?php echo set_value('KasarAmt'); ?>" onfocus="this.select();">
                      <span class="text-danger"><?php echo form_error('KasarAmt'); ?></span>
                    </td>

                    <td>
                      <input readonly style="float: right;width: 15px;padding:1px;background-color:blue;border-color:blue;" class="btn btn-success mr-2" type="submit" accesskey="a" name="Save" id="Save" value="A">
                    </td>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <input class="form-control" id="PartyCode" name="PartyCode" placeholder="PartyCode" value="<?php echo set_value('PartyCode'); ?>" onfocus="this.select();">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-5">
                  ...
                  <input class="form-control" id="Customer" name="Customer" placeholder="CustomerName" value="<?php echo set_value('Customer'); ?>" onfocus="this.select();">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <input class="form-control" id="BrokerCode1" name="BrokerCode1" placeholder="BrokerCode" value="<?php echo set_value('BrokerCode1'); ?>" onfocus="this.select();">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="margin-left:-90px;">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <input type="text" class="form-control pink" id="ReceiptNo" placeholder="Receipt No" name="ReceiptNo" value="<?php echo set_value('ReceiptNo'); ?>">
                  <span class="text-danger"><?php echo form_error('ReceiptNo'); ?></span>
                </div>
                <label class="control-label col-sm-2" for="broker">Slip No.</label>
                <div class="col-sm-2">
                  <input type="text" class="form-control" id="SlipNo" placeholder="SlipNo" name="SlipNo" value="<?php echo set_value('SlipNo'); ?>">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <input type="text" class="form-control blue" id="TotalCashAmt" placeholder="" name="TotalCashAmt" value="<?php echo set_value('TotalCashAmt'); ?>">
                ...
                <div class="col-sm-2">
                  ...
                  <input type="text" class="form-control blue" id="CashCode" placeholder="" name="CashCode" value="<?php echo set_value('CashCode'); ?>">
                  <span class="text-danger"><?php echo form_error('CashCode'); ?></span>
                </div>

                <div class="col-sm-3">
                  <input type="text" class="form-control blue" id="CashTitle" placeholder="" name="CashTitle" value="<?php echo set_value('CashTitle'); ?>">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <input type="text" class="form-control blue" id="TotalChqAmt" placeholder="Chq Amt" name="TotalChqAmt" value="<?php echo set_value('TotalChqAmt'); ?>">
                ...
                <div class="col-sm-2">
                  <input type="text" class="form-control" id="DepBankCode" placeholder="Deposit Bank" name="DepBankCode" value="<?php echo set_value('DepBankCode'); ?>">
                  <span class="text-danger"><?php echo form_error('DepBankCode'); ?></span>
                </div>

                <div class="col-sm-3">
                  <input type="text" class="form-control blue" id="DepBankName" placeholder="" name="DepBankName" value="<?php echo set_value('DepBankName'); ?>">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <input type="text" class="form-control" id="CheqNo" placeholder="Cheq No" name="CheqNo" value="<?php echo set_value('CheqNo'); ?>">
                  <span class="text-danger"><?php echo form_error('CheqNo'); ?></span>
                </div>

                <label class="control-label col-sm-2" for="broker">Bank UTR No.</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="UTRNo" placeholder="UTR No" name="UTRNo" value="<?php echo set_value('UTRNo'); ?>">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <input type="text" class="form-control" id="CheqBankCode" placeholder="Cheque Bank" name="CheqBankCode" value="<?php echo set_value('CheqBankCode'); ?>">
                  <span class="text-danger"><?php echo form_error('CheqBankCode'); ?></span>
                </div>

                <div class="col-sm-4">
                  <input type="text" class="form-control blue" id="CheqBankName" placeholder="" name="CheqBankName" value="<?php echo set_value('CheqBankName'); ?>">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <input type="text" class="form-control" id="TrCode" placeholder="Tr Code" name="TrCode" value="<?php echo set_value('TrCode'); ?>">
                  <span class="text-danger"><?php echo form_error('TrCode'); ?></span>
                </div>

                <label class="control-label col-sm-2" for="broker">Cheque Date</label>
                <div class="col-sm-3">
                  <input type="date" class="form-control" id="ChqDate" placeholder="" name="ChqDate" value="<?php echo set_value('ChqDate'); ?>">
              ...
              <div class="form-group row">
                ...
                <label class="control-label col-sm-2" for="broker">Cheque Amt.</label>
                <div class="col-sm-2">
                  <input type="text" class="form-control blue" id="TotalChqAmt" placeholder="" name="TotalChqAmt" value="<?php echo set_value('TotalChqAmt'); ?>">
                  <span class="text-danger"><?php echo form_error('TotalChqAmt'); ?></span>
                </div>
              </div>
              ...
              <div class="form-group row" hidden>
                ...
                <div class="col-sm-2">
                  <input type="text" class="form-control blue" id="ReturnAmt" placeholder="Refund Amt" name="ReturnAmt" value="<?php echo set_value('ReturnAmt'); ?>">
