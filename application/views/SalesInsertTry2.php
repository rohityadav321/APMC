  ...
  <head>
    ...
    <style type="text/css">
         ...
         /*.tableData3 th, td {
            ...
            #SGSTAmt, #CGSTAmt, #IGSTAmt, #TaxCode, #OCommRate, #CommAmt, #Brand, #ItemDesc, #APMCChrg, #EntryTax,
            #LagaAmt, #TaxableAmt, #CommRate, #OCommRate1, #APMC_Chg, 
            #GodownDesc, #PackingT, #Sale, #SalesCode, #SalesTitle, #TaxTitle, #TaxRate, #Taxable,#TCSAmt
            {
              ...
              if(code == 13 || code === 9) {
                ...
                var GodownI =  $('#GodownI').val();
                  ...
                  $.ajax({
                      ...
                      type: "post",
                      data: {GodownI : GodownI , LotNo : LotNo},
                      dataType: "json",
                      cache: false,
      ...
      <div class="container-fluid">
          <div class="card border-dark">
                <div class="card-header border-dark">
                      <!-- <h5>Collection</h5> -->
                      <center>          
                            <a style="float: right;" id="cancel" accesskey="c" class="btn btn-danger" 
                                  href= "<?php echo base_url() . "index.php/SalesController/DeleteSales/" .$Loaded_List[0]->BillNo ; ?>" tabindex="-1">
                              Cancel (Alt+C)
                            </a>
                                      ...
                                      <table>
                                            <tr>
                                              <td class="firstTable textBlue">Debtor 
                                                  <a  id="areas" type="button" 
                                                        class="btn btn-info" data-toggle="modal" data-target="#DebtorModalForm">
                                                      <i class="glyphicon glyphicon-th"></i>
                                                  </a>
                                              </td>
                                            ...
                                            <tr>
                                                  <td class="firstTable textBlue">Name &nbsp;
                                                        <a  id="areas" type="button" class="btn btn-info" data-toggle="modal" 
                                                              data-target="#CustomerModalForm">
                                                            <i class="glyphicon glyphicon-th"></i>
                                                        </a>
                                                  </td>
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                              <input
                                                ...
                                                name="GodownI"
                                                autofocus
                                                value="<?php echo set_value('GodownID'); ?>"
                                                placeholder="GodownI"
                                                onfocus="this.select();">
                                              <span class="text-danger"><?php echo form_error('GodownID'); ?></span>
                                              ...
                                              <input
                                                ...
                                                name="GrossWtOrginal"
                                                placeholder="GW"
                                                value="<?php echo set_value('GrossWtOrginal'); ?>">
                                                ...
                                                id="APMCChg"
                                                name="APMCChg"
                                                value="<?php echo set_value('APMCChg'); ?>">
                                                ...
                                                id="APMCSChg"
                                                name="APMCSChg"
                                                value="<?php echo set_value('APMCSChg'); ?>">
                                                ...
                                                id="PackingCharge"
                                                name="PackingCharge"
                                                value="<?php echo set_value('PackingCharge'); ?>">
                                          ...
                                          <td>
                                              <input
                                                ...
                                                autocomplete="off" 
                                                onkeydown="focusnext(event)"
                                                value="<?php echo set_value('LotNo'); ?>"
                                                placeholder="LotNo"
                                                onfocus="this.select();">
                                          ...
                                          <td>
                                              <input
                                                ...
                                                autocomplete="off" 
                                                onkeydown="focusnext(event)"
                                                value="<?php echo set_value('ItemCode'); ?>"
                                          ...
                                          <td>
                                              <input
                                                ...
                                                name="ItemMark"
                                                readonly
                                                value="<?php echo set_value('ItemMark'); ?>"
                                          ...
                                          <td>
                                              ...
                                              <input
                                                ...
                                                id="BalQty"
                                                name="BalQty"
                                                value="<?php echo set_value('BalQty'); ?>">
                                          </td>
                                          ...
                                          <td><input
                                                ...
                                                name="NetWt"
                                                onkeydown="focusnext(event)"
                                                value="<?php echo set_value('NetWt'); ?>"
                                                placeholder="NetWt"
                                                onfocus="this.select();">
                                          ...
                                          <td><input
                                                ...
                                                name="APMCIn"
                                                onkeydown="focusnext(event)"
                                                value="<?php echo set_value('APMCIn'); ?>"
                                                placeholder="APMCIn"
                                                onfocus="this.select();"
                                                >
                                          ...
                                          <td><input
                                                ...
                                                value="<?php echo set_value('ETaxIn'); ?>"
                                                placeholder="ETaxIn"
                                                onfocus="this.select();"
                                          ...
                                          <td><input
                                                ...
                                                name="GrAmt"
                                                onkeydown="focusnext(event)"
                                                value="<?php echo set_value('GrAmt'); ?>"
                                                placeholder="GrAmt"
                                                onfocus="this.select();"
                                                >
                                          ...
                                          <td><input
                                                ...
                                                name="NetAmt"
                                                onkeydown="focusnext(event)"
                                                value="<?php echo set_value('NetAmt'); ?>"
                                                placeholder="NetAmt"
                                                tabindex="-1"
                                                onfocus="this.select();"
                                                >
                            ...
                            <table style="width:100%;">
                                <tr>
                                    ...
                                    <td class="firstTable">Rate Per <input 
                                        ...
                                        id="RatePer"
                                        readonly
                                        value="<?php echo set_value('RatePer'); ?>" 
                                        name="RatePer"
                                        placeholder="RatePer"
                                        tabindex="-1"></td>
                                      ...
                                      <td class="firstTable"> 
                                        <input style="float: right;width: 15px;padding:1px;background-color:blue;border-color:blue;" 
                                              class="btn btn-success mr-2" accesskey="a" 
                                              type="submit" name="Save" id="Save" value="A" tabindex="-1">
                                      </td>
                                </tr>
                          <!--   </table> -->
                        </div>
                                  ...
                                  <!-- <table class="tableData3"> -->
                                      <tr>
                                          ...
                                          <td class="firstTable" colspan="2"><input 
                                              ...
                                              id="ItemDesc"
                                              name="ItemDesc"
                                              value="<?php echo set_value('ItemDesc'); ?>"
                            ...
                            <!-- <table class="tableData3"> -->
                              <tr>
                                    ...
                                    <td class="firstTable"><input 
                                        ...
                                        name="TaxCode"
                                        readonly
                                        value="<?php echo set_value('TaxCode'); ?>"
                                        placeholder="TaxCode"
                                        tabindex="-1">
                                    ...
                                    <td class="firstTable" colspan="2"><input 
                                        ...
                                        readonly
                                        name="TaxTitle"
                                        value="<?php echo set_value('TaxTitle'); ?>"
                                    ...
                                    <td class="firstTable"><input 
                                        ...
                                        name="TaxRate"
                                        readonly
                                        value="<?php echo set_value('TaxRate'); ?>"
                                        placeholder="TaxRate"
                                        tabindex="-1">
                                    ...
                                    <td class="firstTable">APMC Chg
                                     <input
                                          ...
                                          name="APMC_Chg"
                                          readonly
                                          value="<?php echo set_value('APMC_Chg'); ?>"
