  ...
  <script>
    ...
    function focusnext(e) {
      ...
      if (document.getElementById("IDNumber").value == "") {
        idarray = ["BillDate", "GodownID", "LRNo", "MudiBazar", "EWayBillNo", "DeliDate", "DebtorID", "SaleType",
            ...
            <div class="card" style="background: #a6b6e0;margin-left: 10px">
              <table>
                ...
                <tr>
                  ...
                  <td class="firstTable"><input type="date" id="BillDate" name="BillDate" autofocus onkeydown="focusnext(event)" onfocus="this.select();" value="<?php echo set_value('BillDate', $Loaded_List[0]->BillDate); ?>" placeholder="BillDate">
                  </td>
                </tr>
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <input oninput="this.value = this.value.toUpperCase()" class="form-control" id="ItemCode" name="ItemCode" autocomplete="off" onkeydown="openmodal(event)" value="<?php echo $SalesDList0 == 1 ? set_value('ItemCode', $SalesDList[0]->ItemCode) : set_value('ItemCode'); ?>" placeholder="ItemCode" onfocus="this.select();">
                  ...
                  <td><input style="height: inherit;" type="text" class="form-control" id="Qty" name="Qty" onkeydown="calculateCharges(event);" value="<?php echo $SalesDList0 == 1 ? set_value('Qty', $SalesDList[0]->Qty) : set_value('Qty'); ?>" placeholder="Qty" onfocus="this.select();">
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <tr>
              ...
              <td>&nbsp;</td>
              <td class="firstTable">
                <input readonly style="float: right;width: 15px;padding:1px;background-color:blue;border-color:blue;" class="btn btn-success mr-2" type="submitxx" name="Add" id="Add" value="U" tabindex="-1">
              </td>
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <tr>
              ...
              <td class="firstTable">
                <input style="width:30px;" type="text" id="TCSPer" name="TCSPer" onkeydown="focusnext(event)" onblur="calculateTCS();" placeholder="<?php echo $SalesDList0 == 1 ? set_value('TCSPer', $SalesDList[0]->TCSPer) : set_value('TCSPer'); ?>" value="<?php echo set_value('TCSPer'); ?>" onfocus="this.select();">
        ...
        <div class="modal-body" id="itemModalBody">
          <table id="ItemList" class="display" border="1">
            ...
            <tbody>
              ...
              ?>
                  <tr>
                    <a data-dismiss="modal" id="closeAccount" href="javascript:void(0);" onclick="ItemCode(
                                                                                                            '<?php echo $List->BalQty; ?>',
                                                                                                            '<?php echo $List->Qty; ?>',
                                                                                                        ); ">
                      <td height="10"><?php echo $i; ?></td>
