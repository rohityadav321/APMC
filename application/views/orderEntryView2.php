...
<head>
  <title>APMC Traders' Software - Order Sales</title>
  ...
  <script type="text/javascript">
    ...
    //? Fetching Data from ItemCode -Pranav 24-621
    $(document).ready(function() {
      $('#XGodownI').keydown(function(e) {
        var code = e.keyCode || e.which;
        if (code == 13 || code === 9) {
          var GodownI = $('#GodownI').val();
          $.ajax({
            url: "<?= base_url() ?>index.php/OrderSalesController/LotWiseitem",
            type: "post",
            data: {
              GodownI: GodownI
            },
            ...
            success: function(result) {
              if (result == 'EMPTY') {
                document.getElementById('ItemMark').focus();
              } else {
                console.log(result.LotWise);
  ...
  <script>
    function SaveMaster(e) {
      if (e.keyCode == 13) {
        ...
        $.ajax({
          url: "<?= base_url() ?>index.php/OrderSalesController/insertOrderHeader",
          data: {
            OrderNo: OrderNo,
            OrderDate: OrderDate,
            ForwardDO: ForwardDO,
    ...
    function InsertOrdDet(e) {
      if (e.keyCode == 13) {

        var OrderNo = $('#OrderNo').val();
        var OrderDate = $('#OrderDate').val();
        var ForwardDO = $('#ForwardDO').val();
        var GodownID = $('#GodownI').val();
        var LotNo = $('#LotNo').val();
        var CreditAcc = $('#SalesCode').val();
        var ItemCode = $('#ItemCode').val();
        var ItemMark = $('#ItemMark').val();
        var OrderQty = $('#Qty').val();
        var OrderBal = $('#BalQty').val();
        var Rate = $('#Rate').val();
        ...
        $.ajax({
          url: "<?= base_url() ?>index.php/OrderSalesController/insertOrderDetails",
          data: {
            OrderNo: OrderNo,
            OrderDate: OrderDate,
            ForwardDO: ForwardDO,
  ...
  <div class="container-fluid" style="overflow:hidden;">
    <div class="card border-dark">
      <div class="card-header border-dark">
        <center>
          <a style="float: right;" id="cancel" accesskey="b" class="btn btn-danger" href="<?php echo base_url() . "index.php/OrderSalesController/show/" ?>" tabindex="-1">Go Back (Alt+B)</a>
          </a>
          <a style="float: right;" id="cancel" accesskey="s" class="btn btn-success" href="<?php echo base_url() . "index.php/OrderSalesController/show/" ?>" tabindex="-1">Save (Alt+S)</a>
          </a>
          &nbsp;
          <?php
          ...
          $WorkYear = $this->session->userdata('WorkYear');
          ?>
          <h4 style="float: left"><?php echo  $CoName . ' - ' . $WorkYear; ?> - Order Entry</h4>
        ...
        <div id="salesHeader" class="row">
          ...
          <div class="col-sm-6">
            <div class="card" style="background: #a6b6e0; margin-left: 10px">
              <table>
                <tr>
                  <td class="firstTable">Order No.</td>
                  <td class="firstTable"><input class="col-sm-5" type="text" id="OrderNo" value="<?php echo $newid; ?>" name="OrderNo" placeholder="OrderNo" tabindex="-1">
                  </td>
                </tr>

                <tr>
                  <td class="firstTable">Order Date</td>
                  <td class="firstTable"><input type="date" id="OrderDate" autofocus name="OrderDate" onkeydown="focusnext(event)" value="<?php echo set_value('OrderDate', $today); ?>" placeholder="OrderDate">
                  </td>
                </tr>
                ...
                <tr>
                  <td class="firstTable">Forward DO</td>
                  <td class="firstTable">
                    <input type="text" class="col-sm-5" id="ForwardDO" value="<?php echo set_value('ForwardDO', 'Y'); ?>" onkeydown="focusnext(event)" name="ForwardDO" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('ForwardDO'); ?></span>
                  </td>
            ...
            <div class="card" style="background: #a6b6e0;margin-right: 10px">
              <table>
                ...
                <tr>
                  ...
                  <td class="firstTable" colspan="2"><input style="width: 95%" type="text" id="LRNo" value="<?php echo set_value('LRNo'); ?>" name="LRNo" onkeydown="SaveMaster(event)" placeholder="LRNo" onfocus="this.select();">
            ...
            <table class="table table-bordered">
              <thead>
                <tr class="yellow">
                  ...
                  <th>
                    <button style="float: right;width:30px;padding:1px;background-color:blue;border-color:blue;" class="btn btn-success mr-0" onkeydown="InsertOrdDet(event)" name="Save" id="Save" tabindex="-1">Add
                      </buttpn>
                  </th>
                </tr>
              </thead>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <input oninput="this.value = this.value.toUpperCase()" class="form-control" id="GodownI" style="width: 50px;" name="GodownI" value="<?php echo set_value('GodownID'); ?>" placeholder="GodownID" onfocus="this.select();">
                  ...
                  <td>
                    <input class="form-control" id="LotNo" name="LotNo" style="width: 50px;" autocomplete="off" value="<?php echo set_value('LotNo'); ?>" placeholder="LotNo" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('LotNo'); ?></span>
                  </td>
                  <td>
                    <input oninput="this.value = this.value.toUpperCase()" class="form-control" id="ItemCode" name="ItemCode" style="width: 50px;" autocomplete="off" onkeydown="focusnext(event)" value="<?php echo set_value('ItemCode'); ?>" placeholder="ItemCode" onfocus="this.select();" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('ItemCode'); ?></span>
                  </td>

                  <td>
                    <input class="form-control" id="ItemDesc" name="ItemDesc" style="width: 350px;" readonly value="<?php echo set_value('ItemDesc'); ?>" placeholder="Item Description" tabindex="-1">
                    <span class="text-danger"><?php echo form_error('ItemDesc'); ?></span>
                  </td>

                  <td>
                    <input class="form-control" id="ItemMark" name="ItemMark" style="width: 50px;" onkeydown="focusnext(event)" value="<?php echo set_value('ItemMark'); ?>" placeholder="Mark" tabindex="-1">
                    <span class="text-danger"><?php echo form_error('ItemMark'); ?></span>
                  </td>
                  <td>
                    <!-- onblur="calculateCharges()" -->

                    <input style="height: inherit; width: 50px;" type="text" class="form-control" id="Qty" onkeydown="focusnext(event)" name="Qty" value="<?php echo set_value('Qty'); ?>" placeholder="Qty" onfocus="this.select();">
                  ...
                  <td>
                    ...
                    <input class="form-control" id="BalQty" name="BalQty" readonly style="width: 50px;" onkeydown="focusnext(event)" value="<?php echo set_value('BalQty'); ?>" placeholder="BalQty" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('GrossWt'); ?>
                    </span>
                  </td>
                  <td><input style="height:inherit;" type="text" class="form-control" id="Rate" name="Rate" style="width: 50px;" onkeydown="focusnext(event)" onblur="focusRate();" value="<?php echo set_value('Rate'); ?>" placeholder="Rate" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('Rate'); ?>
                    </span>
                  </td>
                  <td><input oninput="this.value = this.value.toUpperCase()" maxlength="1" style="padding: 0px;width:50px;" class="form-control" id="APMCIn" name="APMCIn" onkeydown="focusnext(event)" value="<?php echo set_value('APMCIn'); ?>" placeholder="APMCIn" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('APMCIn'); ?>
                    </span>
                  </td>
                  <!-- onblur="calculateGrAmt();" -->
                  <td><input oninput="this.value = this.value.toUpperCase()" maxlength="1" style="padding: 0px;width:50px;" placeholder="ETaxIn" class="form-control" id="ETaxIn" name="ETaxIn" onkeydown="focusnext(event)" value="<?php echo set_value('ETaxIn'); ?>" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('ETaxIn'); ?>
                    </span>
                  </td>
                  <td><input class="form-control" id="TaxCode" name="TaxCode" style="width: 50px;" onkeydown="focusnext(event)" value="<?php echo set_value('TaxCode'); ?>" placeholder="TaxCode" onfocus="this.select();">
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <tr>
              <td class="firstTable">&nbsp;</td>
              <td class="firstTable" colspan="2">
                <input type="text" id="Brand" hidden name="Brand" readonly placeholder="Brand" tabindex="-1">
              </td>


              <td class="firstTable">
                <center>Tax Title &nbsp;&nbsp;&nbsp;</center>
              </td>
          ...
          <div class="col-sm-12">
            ...
            <table class="table tableData">
              ...
              <thead>
                <tr class="yellow">
                  <th>Action</th>
                  <th style="color:#3b5998;">GDN</th>
                  <th>Lot No</th>
                  <th style="color:#3b5998;">Item Code</th>
              ...
              <tbody>
                ...
                <!-- <tr>
                                        ...
                                        <td colspan="3"><center>Bill Amt Total</center>
                                        </td>
    ...
    <div class="modal fade" id="DebtorModalForm" role="dialog">
      <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" style="float: right;">Debator List</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
          </div>
          <div class="modal-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-2">
                    ...
                    <script type="text/javascript">
                      ...
                      var idarray = ["OrderDate", "GodownID", "ForwardDO", "MudiBazar", "DebtorID",
                        "BrokerID", "SalesMan", "LRNo", "GodownI", "LotNo", "ItemCode", "ItemMark",
                        "Qty", "Rate", "APMCIn", "ETaxIn", "Save"
                      ];
                      ...
                      $("#GodownI").keydown(function(event) {
                        if (event.keyCode === 13) {
                          $("#itemModal").click();
                        }
                      });
                      ...
                      $("#itemModal").click(function(e) {
                        ...
                        table = $('#ItemList').DataTable({
                          "ajax": {
                            "type": "POST",
                            "url": '<?php echo base_url() . "index.php/OrderSalesController/LotWiseitem" ?>',
                            "data": {
                              'GID': GID
                            },
                            "dataSrc": "LotWise"
                        ...
                        table.on('select', function(e, dt, type, indexes) {
                            ...
                            for (var i = 0; i < rowData.length; i++) {
                              ...
                              document.getElementById("GodownI").value = GodownI;
                              document.getElementById("GodownDesc").value = GodownI;
                              document.getElementById("LotNo").value = LotNo;
                              document.getElementById("ItemCode").value = ItemCode;
                              document.getElementById("ItemDesc").value = ItemName;
                              document.getElementById("ItemMark").value = ItemMark;
                              ...
                              document.getElementById("RatePer").value = UsualRatePer;
                              document.getElementById("PackingT").value = Packingtext;
                              document.getElementById("TaxTitle").value = TaxCode;
                              document.getElementById("TaxRate").value = TaxRate;
                              document.getElementById("SalesCode").value = SalesCode;
