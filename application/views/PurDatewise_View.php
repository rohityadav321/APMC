...
$downloadfile = 'PurchaseDateWise_' . date("ymdHi");
?>
...
<body>
    <div class="main">
        <div class="headernav">
            ...
            <form method='post' action='<?php echo base_url() ?>index.php/GaruPurchaseController/purDatewiseFilter'>
                <label style="position:absolute;font-size:15px;margin-left:100px;margin-top:-33px;">From : </label>
                <input style="position:absolute;margin-left:150px;margin-top:-42px;" type="date" id="fromYear" name="fromYear">

                <label style="position:absolute;font-size:15px;margin-left:330px;margin-top:-33px;">To : </label>
                <input style="position:absolute;margin-left:360px;margin-top:-42px;" type="date" id="toYear" name="toYear">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var reporttitle = 'Purchase DateWise Report from ' + fromYear + ' To ' + toYear;
            CoName = CoName.replace(/%20/g, " ");
            $('#example').DataTable({
                responsive: true,
                dom: 'lBfrtip',
