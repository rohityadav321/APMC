        ...
        if (code == 13 || code === 9) {
          ...
          $.ajax({
            ...
            success: function(result) {
              ...
              alert("Now Select Item to Edit (if any) or Save & Exit !!!");
              document.getElementById("salesDetails").style.pointerEvents = "auto";
              document.getElementById("salesDetails").style.opacity = 1;
    ...
    <div class="card border-dark">
      <div class="card-header border-dark">
        <center>
          ...
          <!-- 170521 removed save updateSalesHeader Function as it was not called and gave option show controller  -->
          <!-- <a style="float: right;" accesskey="a" class="btn btn-success mr-2" onclick="updateSalesHeader();" tabindex="-1">Save(Alt+A)</a> -->
          <a style="float: right;" accesskey="a" class="btn btn-success mr-2" href="<?php echo base_url() . "index.php/SalesController/show/" ?>" tabindex="-1">Save(Alt+A)</a>
          ...
          <a style="float: right;background-color:#3b5998;border-color:#AED6F1;" id="printInvoice" class="btn btn-success mr-2" tabindex="-1" target="_blank" href="<?php echo base_url() . "index.php/SalesController/getLogoInvoiceData/" . $Loaded_List[0]->BillNo; ?>">
            Print Invoice
          </a>
          &nbsp;
          <?php
            ...
            <div class="card" style="background: #a6b6e0;margin-left: 10px">
              <table>
                <tr>
                  ...
                  <td class="firstTable"><input class="col-sm-5" type="text" id="BillNo" value="<?php echo set_value('BillNo', $Loaded_List[0]->BillNo); ?>" name="BillNo" placeholder="BillNo">
                  </td>
                </tr>

                <tr>
                  <td class="firstTable">Bill Date</td>
                  <td class="firstTable"><input type="date" id="BillDate" name="BillDate" autofocus onkeydown="focusnext(event)" value="<?php echo set_value('BillDate', $Loaded_List[0]->BillDate); ?>" placeholder="BillDate">
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td class="firstTable" colspan="4"><input class="col-sm-2" type="text" id="GodownID" value="<?php echo set_value('GodownID', $Loaded_List[0]->GodownID); ?>" name="GodownID" placeholder="GodownID" onfocus="this.select();">
                    ...
                    &nbsp;&nbsp;
                    <input class="col-sm-5" type="text" id="GodownTitle" name="GodownTitle" value="<?php echo set_value('GodownDesc', $Loaded_List[0]->GodownDesc); ?>" placeholder="GodownTitle" readonly>
                  </td>
                  <td></td>
                </tr>
                ...
                <tr>
                  ...
                  <td class="firstTable" colspan="2"><input style="width: 95%" type="text" id="LRNo" name="LRNo" value="<?php echo set_value('LRNo', $Loaded_List[0]->LRNo); ?>" onkeydown="focusnext(event)" placeholder="LRNo" onfocus="this.select();">
                ...
                <tr>
                  ...
                  <td class="firstTable"><input type="text" class="col-sm-5" id="MudiBazar" value="<?php echo set_value('MudiBazar', $Loaded_List[0]->MudiBazar); ?>" onkeydown="focusnext(event)" name="MudiBazar" placeholder="Y" onfocus="this.select();">
                  ...
                  <td class="firstTable"><input type="text" id="EWayBillNo" name="EWayBillNo" value="<?php echo set_value('EWayBillNo', $Loaded_List[0]->EWayBillNo); ?>" onkeydown="focusnext(event)" placeholder="EWayBillNo" onfocus="this.select();">
                ...
                <tr>
                  ...
                  <td class="firstTable">
                    <input type="date" onkeydown="focusnext(event)" id="DeliDate" value="<?php echo set_value('DeliDate', date_format(date_create($Loaded_List[0]->DeliDate), "Y-m-d")); ?>" name="DeliDate">
              ...
              <table>
                ...
                <tr>
                  ...
                  <td class="firstTable" colspan="3">
                    <input class="col-sm-2" type="text" id="DebtorID" value="<?php echo set_value('DebtorID', $Loaded_List[0]->DebtorID); ?>" name="DebtorID" placeholder="DebtorID" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('DebtorID'); ?>
                    </span>

                    <input type="text" style="width: 55%" id="DebtorTitle" name="DebtorTitle" value="<?php echo set_value('DebtorTitle', $DebtorID[0]->ACTitle); ?>" placeholder="Debtor name" readonly>
                  </td>
                  <td class="firstTable"></td>
                  <td class="firstTable"></td>
                </tr>
                ...
                <tr>
                  ...
                  <td class="firstTable" colspan="3">
                    <input class="col-sm-2" type="text" id="PartyCode" name="PartyCode" value="<?php echo set_value('PartyCode', $Loaded_List[0]->PartyCode); ?>" placeholder="PartyCode" onfocus="this.select();">
                    <input type="text" id="CPName" style="width: 55%" value="<?php echo set_value('CPName', $Loaded_List[0]->CPName); ?>" name="CPName" placeholder="Party Name" onfocus="this.select();">
                ...
                <tr>
                  ...
                  <td class="firstTable"><input type="text" id="Area" onkeydown="focusnext(event)" name="Area" value="<?php echo set_value('Area', $Loaded_List[0]->Area); ?>" placeholder="Area" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('Area'); ?>
                    </span>
                  </td>

                  <td class="firstTable" colspan="2">Sale Type
                    <input type="text" id="SaleType" onkeydown="focusnext(event)" value="<?php echo set_value('SaleType', $Loaded_List[0]->SaleType); ?>" name="SaleType" placeholder="SaleType" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('SaleType'); ?>
                    </span>
                  </td>
                  <td>
                    <p id="PartyCode" name="PartyCode"></p>
                  </td>
                  <td class="firstTable"></td>
                ...
                <tr>
                  ...
                  <td class="firstTable" colspan="3"><input class="col-sm-2" type="text" id="BrokerID" value="<?php echo set_value('BrokerID', $Loaded_List[0]->BrokerID); ?>" name="BrokerID" placeholder="BrokerID" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('BrokerID'); ?>
                    </span>

                    <input type="text" style="width: 48%" id="BrokerTitle" name="BrokerTitle" value="<?php echo set_value('BrokerTitle', $Loaded_List[0]->BrokerTitle); ?>" placeholder="BrokerTitle" onfocus="this.select();">
                ...
                <tr>
                  ...
                  <td class="firstTable"><input type="text" id="HelMajuri" value="<?php echo set_value('HelMajuri', $Loaded_List[0]->HelMajuri); ?>" onkeydown="focusnext(event)" name="HelMajuri" placeholder="Hel/Majuri" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('HelMajuri'); ?>
                    </span>
                  </td>
                  <td class="firstTable">Other charges/ Disc.</td>
                  <td class="firstTable"><input type="text" id="OtherChrgs" onkeydown="focusnext(event)" value="<?php echo set_value('OtherChrgs', $Loaded_List[0]->OtherChrgs); ?>" name="OtherChrgs" placeholder="OtherChrgs" onfocus="this.select();">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  ...
                  <td><input oninput="this.value = this.value.toUpperCase()" class="form-control" id="GodownI" onkeydown="focusnext(event)" name="GodownI" value="<?php echo $SalesDList0 == 1 ? set_value('GodownID', $SalesDList[0]->GodownID) : set_value('GodownID'); ?>" placeholder="GodownI" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('GodownID'); ?>
                    </span>

                  </td>
                  <td><input class="form-control" id="LotNo" onkeydown="focusnext(event)" name="LotNo" value="<?php echo $SalesDList0 == 1 ? set_value('LotNo', $SalesDList[0]->LotNo) : set_value('LotNo'); ?>" placeholder="LotNo" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('LotNo'); ?>
                    </span>

                    <input class="form-control" type="hidden" id="PackingCharge" name="PackingCharge" value="<?php echo $SalesDList0 == 1 ? set_value('PackingCharge', $SalesDetails[0]->PackingChrg) : set_value('PackingCharge'); ?>">
                    <input class="form-control" type="hidden" id="Laga" name="Laga" value="<?php echo $SalesDList0 == 1 ? set_value('Laga', $SalesDList[0]->Laga) : set_value('Laga'); ?>">
                    <input class="form-control" type="hidden" id="APMCSChg" name="APMCSChg" value="<?php echo $SalesDList0 == 1 ? set_value('APMCSChg', $SalesDList[0]->APMCSChg) : set_value('APMCSChg'); ?>">
                    <input class="form-control" type="hidden" id="APMCChg" name="APMCChg" value="<?php echo $SalesDList0 == 1 ? set_value('APMCChg', $SalesDList[0]->APMCChg) : set_value('APMCChg'); ?>">

                    <input class="form-control" type="hidden" id="NetWtOriginal" name="NetWtOriginal" value="<?php echo $SalesDList0 == 1 ? set_value('NetWtOriginal', $SalesDList[0]->NetWtOriginal) : set_value('NetWtOriginal'); ?>">

                    <input class="form-control" type="hidden" id="GrossWtOrginal" name="GrossWtOrginal" value="<?php echo $SalesDList0 == 1 ? set_value('GrossWtOrginal', $SalesDetails[0]->Packing) : set_value('GrossWtOrginal'); ?>">
                  </td>
                  <td><input oninput="this.value = this.value.toUpperCase()" class="form-control" id="ItemCode" name="ItemCode" autocomplete="off" onkeydown="focusnext(event)" value="<?php echo $SalesDList0 == 1 ? set_value('ItemCode', $SalesDList[0]->ItemCode) : set_value('ItemCode'); ?>" placeholder="ItemCode" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('ItemCode'); ?>
                    </span>
                  </td>
                  <td><input class="form-control" id="ItemMark" onkeydown="focusnext(event)" name="ItemMark" value="<?php echo $SalesDList0 == 1 ? set_value('ItemMark', $SalesDList[0]->ItemMark) : set_value('ItemMark'); ?>" placeholder="ItemMark" readonly tabindex="-1">
                    <span class="text-danger"><?php echo form_error('ItemMark'); ?>
                    </span>

                    <input class="form-control" type="hidden" id="IDNumber" name="IDNumber" value="<?php echo $SalesDList0 == 1 ? set_value('IDNumber', $SalesDList[0]->ID) : set_value('IDNumber'); ?>">
                  </td>

                  <!-- onkeydown="focusnext(event)" -->

                  <td><input style="height: inherit;" type="text" class="form-control" id="Qty" onkeydown="calculateCharges(event);" name="Qty" value="<?php echo $SalesDList0 == 1 ? set_value('Qty', $SalesDList[0]->Qty) : set_value('Qty'); ?>" placeholder="Qty" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('Qty'); ?>
                    </span>

                    <input type="hidden" class="form-control" id="BalQty" name="BalQty" value="<?php echo $SalesDList0 == 1 ? set_value('BalQty', $SalesDList[0]->BalQty) : set_value('BalQty'); ?>">

                    <input class="form-control" type="hidden" id="Weight" name="Weight" value="<?php echo $SalesDList0 == 1 ? set_value('Weight', $SalesDetails[0]->Weight) : set_value('Weight'); ?>">
                  </td>
                  <td><input class="form-control" id="GrossWt" name="GrossWt" onkeydown="focusnext(event)" onblur="calculateNetW()" value="" placeholder="<?php echo $SalesDList0 == 1 ? set_value('GrossWt', $SalesDList[0]->GrossWt) : set_value('GrossWt'); ?>" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('GrossWt'); ?>
                    </span>
                  </td>
                  <td><input class="form-control" id="NetWt" name="NetWt" onkeydown="focusnext(event)" value="<?php echo $SalesDList0 == 1 ? set_value('NetWt', $SalesDList[0]->NetWt) : set_value('NetWt'); ?>" placeholder="NetWt" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('NetWt'); ?>
                    </span>
                  </td>
                  <td><input style="height: inherit;" type="text" class="form-control" id="Rate" name="Rate" onkeydown="focusnext(event)" value="<?php echo $SalesDList0 == 1 ? set_value('Rate', $SalesDList[0]->Rate) : set_value('Rate'); ?>" placeholder="Rate" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('Rate'); ?>
                    </span>
                  </td>
                  <td><input oninput="this.value = this.value.toUpperCase()" maxlength="1" style="padding: 0px;width:25px;" class="form-control" id="APMCIn" name="APMCIn" onkeydown="focusnext(event)" value="<?php echo $SalesDList0 == 1 ? set_value('APMCIn', $SalesDList[0]->APMCIn) : set_value('APMCIn'); ?>" placeholder="APMCIn" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('APMCIn'); ?>
                    </span>
                  </td>
                  <td><input oninput="this.value = this.value.toUpperCase()" maxlength="1" style="padding: 0px;width:25px;" class="form-control" id="ETaxIn" name="ETaxIn" onkeydown="focusnext(event)" onblur="calculateGrAmt();" value="<?php echo $SalesDList0 == 1 ? set_value('ETaxIn', $SalesDList[0]->ETaxIn) : set_value('ETaxIn'); ?>" placeholder="ETaxIn" onfocus="this.select();"><span class="text-danger"><?php echo form_error('ETaxIn'); ?>
                    </span>
                  </td>
                  <td><input class="form-control" id="GrAmt" name="GrAmt" onkeydown="focusnext(event)" value="<?php echo $SalesDList0 == 1 ? set_value('GrAmt', $SalesDList[0]->GrAmt) : set_value('GrAmt'); ?>" placeholder="GrAmt" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('GrAmt'); ?>
                    </span>
                  </td>
                  <td><input class="form-control" id="ContChrg" name="ContChrg" onkeydown="focusnext(event)" onblur="calculateNetAmt();" value="<?php echo set_value('ContChrg'); ?>" placeholder="<?php echo $SalesDList0 == 1 ? set_value('ContChrg', $SalesDList[0]->ContChrg) : set_value('ContChrg'); ?>" onfocus="this.select();">
                    <span class="text-danger"><?php echo form_error('ContChrg'); ?>
                    </span>
                  </td>
                  <td><input class="form-control" id="NetAmt" name="NetAmt" value="<?php echo $SalesDList0 == 1 ? set_value('NetAmt', $SalesDList[0]->NetAmt) : set_value('NetAmt'); ?>" onkeydown="focusnext(event)" placeholder="NetAmt" tabindex="-1" onfocus="this.select();">
          ...
          <div class="col-sm-12" style="padding-left: 20px; padding-right: 20px">
            <table style="width:100%;">
              <tr>
                ...
                <td colspan="2"><input type="text" id="GdnTitle" name="GdnTitle" value="<?php echo $SalesDList0 == 1 ? set_value('GdnTitle', $SalesDList[0]->GodownDesc) : set_value('GdnTitle'); ?>" placeholder="GdnTitle" readonly tabindex="-1">
                </td>
                ...
                <td class="firstTable"><input type="text" value="<?php echo $SalesDList0 == 1 ? set_value('Packing', $SalesDetails[0]->Packing) : set_value('Packing'); ?>" id="Packing" name="Packing" placeholder="Packing" readonly tabindex="-1">
                </td>

                <td class="firstTable">
                  <center>Packing Text</center>
                </td>
                <td class="firstTable"><input type="text" id="PackingT" value="<?php echo $SalesDList0 == 1 ? set_value('PackingT', $SalesDetails[0]->PackingText) : set_value('PackingT'); ?>" name="PackingT" placeholder="Packing Test" readonly tabindex="-1">
                </td>

                <td class="firstTable"> &nbsp;&nbsp;&nbsp; Sale Type <input style="width: 40%" type="text" id="Sale" name="Sale" placeholder="Sale " readonly tabindex="-1"></td>


                <td class="firstTable">Rate Per <input type="text" value="<?php echo $SalesDList0 == 1 ? set_value('RatePer', $SalesDList[0]->RATEPER) : set_value('RatePer'); ?>" id="RatePer" name="RatePer" placeholder="RatePer" readonly tabindex="-1"></td>

                <td class="firstTable">
                  <center>Disc %</center>
                </td>
                <td class="firstTable"> <input type="text" style="width: 40px;" id="DiscDetRate" name="DiscDetRate" onkeydown="focusnext(event)" onblur="calculateDiscount();" placeholder="<?php echo $SalesDList0 == 1 ? set_value('DiscDetRate', $SalesDList[0]->DiscDetRate) : set_value('DiscDetRate'); ?>" value="<?php echo set_value('DiscDetRate'); ?>" onfocus="this.select();">
                ...
                <!-- </td> -->
                <td class="firstTable">
                  <input style="margin-left:-100px;width:85px;" type="text" id="DiscAmt" name="DiscAmt" value="<?php echo $SalesDList0 == 1 ? set_value('DiscAmt', $SalesDList[0]->DiscAmt) : set_value('DiscAmt'); ?>" placeholder="DiscAmt" readonly>
                  <span class="text-danger"><?php echo form_error('DiscAmt'); ?></span>
                </td>

                <td class="firstTable">
                  <input readonly class="btn btn-success mr-2" style="float:right;width: 15px;padding:1px;background-color:green;border-color:green;" name="AddNewEntry" id="AddNewEntry" value="A" tabindex="-1">
                </td>

                <td class="firstTable">
                  <input readonly style="float: right;width: 15px;padding:1px;background-color:blue;border-color:blue;" class="btn btn-success mr-2" name="Add" id="Add" value="U">
                </td>
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <tr>
              ...
              <td class="firstTable" colspan="2"><input type="text" id="ItemName" name="ItemName" value="<?php echo $SalesDList0 == 1 ? set_value('ItemName', $SalesDList[0]->ItemName) : set_value('ItemName'); ?>" placeholder="Item Desc" readonly tabindex="-1">
              </td>
              <!-- <td></td> -->
              ...
              <td class="firstTable"><input type="text" id="SalesCode" name="SalesCode" value="<?php echo $SalesDList0 == 1 ? set_value('SalesCode', $SalesDList[0]->SalesCode) : set_value('SalesCode'); ?>" placeholder="SalesCode" readonly tabindex="-1">
              </td>
              <td class="firstTable" colspan="2"><input style="width: 100%" type="text" id="SalesTitle" name="SalesTitle" value="<?php echo $SalesDList0 == 1 ? set_value('SalesTitle', $SalesDList[0]->SalesTitle) : set_value('SalesTitle'); ?>" placeholder="" readonly tabindex="-1">
                <span class="text-danger"><?php echo form_error('SalesTitle'); ?>
                </span>
              </td>
              <!-- <td></td> -->

              <td class="firstTable"><input type="text" id="OCommRate" name="OCommRate" value="<?php echo set_value('OCommRate'); ?>" placeholder="OCommRate" readonly tabindex="-1">
                <span class="text-danger"><?php echo form_error('OCommRate'); ?>
                </span>
              </td>
              <td class="firstTable"><input type="text" id="OCommRate1" name="OCommRate1" placeholder="OCommRate1" readonly tabindex="-1">
                <span class="text-danger"><?php echo form_error('OCommRate'); ?>
                </span>
              </td>
              ...
              <td class="firstTable"><input type="text" id="Taxable" name="Taxable" readonly value="<?php echo $SalesDList0 == 1 ? set_value('Taxable', $SalesDList[0]->TaxableAmt) : set_value('TaxableAmt'); ?>" placeholder="Taxable" tabindex="-1">
              ...
              <td class="firstTable">
                <input readonly style="float: right;width: 15px;padding:1px;background-color:blue;border-color:blue;" class="btn btn-success mr-2" name="Add" id="Add" value="U" tabindex="-1">
              </td>
          ...
          <div class="col-sm-12">
            ...
            <tr>
              ...
              <td class="firstTable" colspan="2">
                <input type="text" id="Brand" name="Brand" placeholder="Brand" readonly tabindex="-1">
              </td>

              <td class="firstTable">
                <center>Tax Code&nbsp;&nbsp;&nbsp;</center>
              </td>
              <td class="firstTable"><input type="text" id="TaxCode" name="TaxCode" value="<?php echo $SalesDList0 == 1 ? set_value('TaxCode', $SalesDList[0]->TaxCode) : set_value('TaxCode'); ?>" placeholder="TaxCode" readonly tabindex="-1">
                <span class="text-danger"><?php echo form_error('TaxCode'); ?>
                </span>
              </td>
              <td class="firstTable" colspan="2"><input style="width: 100%" type="text" id="TaxTitle" name="TaxTitle" value="<?php echo $SalesDList0 == 1 ? set_value('TaxTitle', $SalesDList[0]->TaxTitle) : set_value('TaxTitle'); ?>" placeholder="TaxTitle" readonly tabindex="-1">
                <span class="text-danger"><?php echo form_error('TaxTitle'); ?>
                </span>
                </span>
              </td>
              <!-- <td></td> -->
              <td class="firstTable"><input type="text" id="TaxRate" name="TaxRate" value="<?php echo $SalesDList0 == 1 ? set_value('TaxRate', $SalesDList[0]->TaxRate) : set_value('TaxRate'); ?>" placeholder="TaxRate" readonly tabindex="-1">
              ...
              <td class="firstTable">APMC Chg
                <input type="text" id="APMC_Chg" name="APMC_Chg" readonly value="<?php echo $SalesDList0 == 1 ? set_value('APMC_Chg', $SalesDList[0]->OAPMCChrg) : set_value('APMC_Chg'); ?>" placeholder="APMC Chg" readonly tabindex="-1">
              ...
              <td class="firstTable">
                <input style="width:30px;" type="text" id="TCSPer" name="TCSPer" onkeydown="calculateTCS(event);" placeholder="<?php echo $SalesDList0 == 1 ? set_value('TCSPer', $SalesDList[0]->TCSPer) : set_value('TCSPer'); ?>" value="<?php echo set_value('TCSPer'); ?>" onfocus="this.select();">
                <span class="text-danger"><?php echo form_error('TCSPer'); ?></span>
              </td>

              <td class="firstTable">
                <input style="margin-left:-105px;width:100px;" type="text" id="TCSAmt" name="TCSAmt" value="<?php echo $SalesDList0 == 1 ? set_value('TCSAmt', $SalesDList[0]->TCSAmount) : set_value('TCSAmt'); ?>" placeholder="TCS Amt" onfocus="this.select();">
        ...
        <div class="modal-body" id="NWeightModalBody">
          <table id="ItemList" class="display" border="1">
            ...
            <tbody>
              <tr>
                <td>
                  <input id="WgtDiff" name="WgtDiff" onkeydown="NWtfocusnext(event)" type="text" style="outline: none;border: none;border-color: transparent;text-align:right;" value="<?php echo $SalesDList0 == 1 ? set_value('WgtDiff', $SalesDList[0]->WgtDiff) : set_value('WgtDiff', '0.000'); ?>" onfocus="this.select();">
                </td>

                <td>
                  <input id="RateDiff" name="RateDiff" onkeydown="NWtfocusnext(event)" type="text" style="outline: none;border: none;border-color: transparent;text-align:right;" value="<?php echo $SalesDList0 == 1 ? set_value('RateDiff', $SalesDList[0]->RateDiff) : set_value('RateDiff', '0.00'); ?>" onfocus="this.select();">
                </td>

                <td>
                  <input id="Code1" name="Code1" class="Code" type="text" style="outline: none;border: none;border-color: transparent;" value="<?php echo $SalesDList0 == 1 ? set_value('Code1', $SalesDList[0]->Code1) : set_value('Code1'); ?>" onblur="calculateDiffAmt1();" onfocus="this.select();">
                </td>

                <td>
                  <input id="CodeName1" name="CodeName1" type="text" style="outline: none;border: none;border-color: transparent;" value="<?php echo $SalesDList0 == 1 ? set_value('CodeName1', $SalesDList[0]->CodeName1) : set_value('CodeName1'); ?>" readonly>
                </td>

                <td>
                  <input id="DiffAmt1" name="DiffAmt1" type="text" style="outline: none;border: none;border-color: transparent;text-align:right;" value="<?php echo $SalesDList0 == 1 ? set_value('DiffAmt1', $SalesDList[0]->DiffAmt1) : set_value('DiffAmt1', '0.00'); ?>" readonly>
                </td>
              </tr>

              <tr>
                <td>
                  <input id="WgtDiff1" name="WgtDiff1" onkeydown="NWtfocusnext(event)" type="text" style="outline: none;border: none;border-color: transparent;text-align:right;" value="<?php echo $SalesDList0 == 1 ? set_value('WgtDiff1', $SalesDList[0]->WgtDiff1) : set_value('WgtDiff1', '0.000'); ?>" onfocus="this.select();">
                </td>

                <td>
                  <input id="RateDiff1" name="RateDiff1" onkeydown="NWtfocusnext(event)" type="text" style="outline: none;border: none;border-color: transparent;text-align:right;" value="<?php echo $SalesDList0 == 1 ? set_value('RateDiff1', $SalesDList[0]->RateDiff1) : set_value('RateDiff1', '0.00'); ?>" onfocus="this.select();">
                </td>

                <td>
                  <input id="Code2" name="Code2" class="Code" type="text" style="outline: none;border: none;border-color: transparent;" value="<?php echo $SalesDList0 == 1 ? set_value('Code2', $SalesDList[0]->Code2) : set_value('Code2'); ?>" onblur="calculateDiffAmt2();" onfocus="this.select();">
                </td>

                <td>
                  <input id="CodeName2" name="CodeName2" type="text" style="outline: none;border: none;border-color: transparent;" value="<?php echo $SalesDList0 == 1 ? set_value('CodeName2', $SalesDList[0]->CodeName2) : set_value('CodeName2'); ?>" readonly>
                </td>

                <td>
                  <input id="DiffAmt2" name="DiffAmt2" type="text" style="outline: none;border: none;border-color: transparent;text-align:right;" value="<?php echo $SalesDList0 == 1 ? set_value('DiffAmt2', $SalesDList[0]->DiffAmt2) : set_value('DiffAmt2', '0.00'); ?>" readonly>
                </td>
              </tr>

              <tr>
                <td>
                  <input id="WgtDiff2" name="WgtDiff2" onkeydown="NWtfocusnext(event)" type="text" style="outline: none;border: none;border-color: transparent;text-align:right;" value="<?php echo $SalesDList0 == 1 ? set_value('WgtDiff2', $SalesDList[0]->WgtDiff2) : set_value('WgtDiff2', '0.000'); ?>" onfocus="this.select();">
                </td>

                <td>
                  <input id="RateDiff2" name="RateDiff2" onkeydown="NWtfocusnext(event)" type="text" style="outline: none;border: none;border-color: transparent;text-align:right;" value="<?php echo $SalesDList0 == 1 ? set_value('RateDiff2', $SalesDList[0]->RateDiff2) : set_value('RateDiff2', '0.00'); ?>" onfocus="this.select();">
                </td>

                <td>
                  <input id="Code3" name="Code3" class="Code" type="text" style="outline: none;border: none;border-color: transparent;" value="<?php echo $SalesDList0 == 1 ? set_value('Code3', $SalesDList[0]->Code3) : set_value('Code3'); ?>" onblur="calculateDiffAmt3();" onfocus="this.select();">
                </td>

                <td>
                  <input id="CodeName3" name="CodeName3" type="text" style="outline: none;border: none;border-color: transparent;" value="<?php echo $SalesDList0 == 1 ? set_value('CodeName3', $SalesDList[0]->CodeName3) : set_value('CodeName3'); ?>" readonly>
                </td>

                <td>
                  <input id="DiffAmt3" name="DiffAmt3" type="text" style="outline: none;border: none;border-color: transparent;text-align:right;" value="<?php echo $SalesDList0 == 1 ? set_value('DiffAmt3', $SalesDList[0]->DiffAmt3) : set_value('DiffAmt3', '0.00'); ?>" readonly>
                </td>
              </tr>

              <tr>
                <td>
                  <input id="WgtDiff3" name="WgtDiff3" onkeydown="NWtfocusnext(event)" type="text" style="outline: none;border: none;border-color: transparent;text-align:right;" value="<?php echo $SalesDList0 == 1 ? set_value('WgtDiff3', $SalesDList[0]->WgtDiff3) : set_value('WgtDiff3', '0.000'); ?>" onfocus="this.select();">
                </td>

                <td>
                  <input id="RateDiff3" name="RateDiff3" onkeydown="NWtfocusnext(event)" type="text" style="outline: none;border: none;border-color: transparent;text-align:right;" value="<?php echo $SalesDList0 == 1 ? set_value('RateDiff3', $SalesDList[0]->RateDiff3) : set_value('RateDiff3', '0.00'); ?>" onfocus="this.select();">
                </td>

                <td>
                  <input id="Code4" name="Code4" class="Code" type="text" style="outline: none;border: none;border-color: transparent;" value="<?php echo $SalesDList0 == 1 ? set_value('Code4', $SalesDList[0]->Code4) : set_value('Code4'); ?>" onblur="calculateDiffAmt4();" onfocus="this.select();">
                </td>

                <td>
                  <input id="CodeName4" name="CodeName4" type="text" style="outline: none;border: none;border-color: transparent;" value="<?php echo $SalesDList0 == 1 ? set_value('CodeName4', $SalesDList[0]->CodeName4) : set_value('CodeName4'); ?>" readonly>
                </td>

                <td>
                  <input id="DiffAmt4" name="DiffAmt4" type="text" style="outline: none;border: none;border-color: transparent;text-align:right;" value="<?php echo $SalesDList0 == 1 ? set_value('DiffAmt4', $SalesDList[0]->DiffAmt4) : set_value('DiffAmt4', '0.00'); ?>" readonly>
                </td>
              </tr>

              <tr>
                <td>
                  <input id="WgtDiff4" name="WgtDiff4" onkeydown="NWtfocusnext(event)" type="text" style="outline: none;border: none;border-color: transparent;text-align:right;" value="<?php echo $SalesDList0 == 1 ? set_value('WgtDiff4', $SalesDList[0]->WgtDiff4) : set_value('WgtDiff4', '0.000'); ?>" onfocus="this.select();">
                </td>

                <td>
                  <input id="RateDiff4" name="RateDiff4" onkeydown="NWtfocusnext(event)" type="text" style="outline: none;border: none;border-color: transparent;text-align:right;" value="<?php echo $SalesDList0 == 1 ? set_value('RateDiff4', $SalesDList[0]->RateDiff4) : set_value('RateDiff4', '0.00'); ?>" onfocus="this.select();">
                </td>

                <td>
                  <input id="Code5" name="Code5" class="Code" type="text" style="outline: none;border: none;border-color: transparent;" value="<?php echo $SalesDList0 == 1 ? set_value('Code5', $SalesDList[0]->Code5) : set_value('Code5'); ?>" onblur="calculateDiffAmt5();" onfocus="this.select();">
                </td>

                <td>
                  <input id="CodeName5" name="CodeName5" type="text" style="outline: none;border: none;border-color: transparent;" value="<?php echo $SalesDList0 == 1 ? set_value('CodeName5', $SalesDList[0]->CodeName5) : set_value('CodeName5'); ?>" readonly>
                </td>

                <td>
                  <input id="DiffAmt5" name="DiffAmt5" type="text" style="outline: none;border: none;border-color: transparent;text-align:right;padding:0px;" value="<?php echo $SalesDList0 == 1 ? set_value('DiffAmt5', $SalesDList[0]->DiffAmt5) : set_value('DiffAmt5', '0.00'); ?>" readonly>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <input id="totalDiffAmt" type="text" style="outline: none;border: none;border-color: transparent;text-align: right;font-weight:bold;padding:5px;" value="<?php echo $SalesDList0 == 1 ? set_value('totalDiffAmt', $SalesDList[0]->totalDiffAmt) : set_value('totalDiffAmt'); ?>" readonly>
                </td>
              </tr>
            </tbody>
          </table>
            ...
            <div class="col-sm-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  ...
                  <script>
                    $("#BillDate").keydown(function(event) {
                      if (event.keyCode === 13) {
                        document.getElementById("GodownID").focus();
                      }
                    });

                    $("#LRNo").keydown(function(event) {
                      if (event.keyCode === 13) {
                        document.getElementById("MudiBazar").focus();
                      }
                    });

                    $("#MudiBazar").keydown(function(event) {
                      if (event.keyCode === 13) {
                        document.getElementById("EWayBillNo").focus();
                      }
                    });

                    $("#EWayBillNo").keydown(function(event) {
                      if (event.keyCode === 13) {
                        document.getElementById("DeliDate").focus();
                      }
                    });

                    $("#DeliDate").keydown(function(event) {
                      if (event.keyCode === 13) {
                        document.getElementById("DebtorID").focus();
                      }
                    });
                    ...
                    $("#HelMajuri").keydown(function(event) {
                      if (event.keyCode == 13)
                        $("#OtherChrgs").focus();
                    });
                  </script>
    ...
    <div class="modal-dialog modal-md">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a style="float: right;background-color:#ffb366;border-color:#ffb366;" id="closeInvoice" class="btn btn-success mr-2" tabindex="-1" href="<?php echo base_url() . "index.php/SalesController/showTry/"; ?>">
            Close
          </a>
          <!-- <button type="button" class="btn btn-default" data-dismiss="modal">Close</button> -->
        </div>
