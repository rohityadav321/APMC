    ...
    <div class="card border-dark" style="width: 100%; background: darkblue;">
        <div class="card-header border-dark" style="text-align:center;">
            ...
            <center>
                ...
                &nbsp;
                <!--                 
                <a style="float: right; margin-right:10px;" href="<?php echo base_url() . "index.php/PaymentTdsController/show"; ?>">
                    <button class="btn btn-success "><i class="glyphicon glyphicon-print"></i> Save</button>
                </a>
 -->
                <a style="float: right; margin-right:10px;" id="AddTdsDet" name="AddTdsDet" href="<?php echo base_url() . "index.php/PaymentTdsController/show"; ?>">
                    <button class="btn btn-success "><i class="glyphicon glyphicon-print"></i> Save</button>
                </a>
    ...
    <script>
        $(document).ready(function() {
            $('#xxxxAddTdsDet').keydown(function(e) {
                ...
                if (code == 13 || code === 9) {
                    ...
                    $.ajax({
                        url: "<?= base_url() ?>index.php/PaymentTdsController/insertTdsData",
                        data: {
                            EntryDate: EntryDate,
                            PayUpto: PayUpto,
                            TdsType: TdsType,
                        ...
                        cache: false,
                        success: function() {
                            alert("Data Inserted in TDS Payment");
    ...
    <div class="container ">
        ...
        <div>
                ...
                <div class="payments">
                    <fieldset style="width: 50vw; display: flex; justify-content: flex-start; flex-direction: column;">
                        ...
                        <div>
                            ...
                            <input type="text" id="IdNumber" onkeydown="focusnext(event)" name="IdNumber" value="<?php echo $id; ?>" readonly placeholder="ID Number" />

                        </div>
                        <div>
                            <label>Entry Date</label>
                            <input type="date" onkeydown="focusnext(event)" name="EntryDate" id="EntryDate" value="<?php echo $today ?>" autofocus />
                            <label style="padding-left: 15px;">Paid Upto</label>
                            <input type="date" onkeydown="focusnext(event)" name="PaidDate" id="PaidDate" />
                        </div>
                        <div>
                            <label>Payment Type</label>
                            <input type="text" name="PayTypeCode" id="PaytypeCode" placeholder="Payment Type" />
                            <input type="text" id="PaytypeName" name="PayTypename" placeholder="Payment Type" readonly style="background: rgb(203, 203, 245);" />
                        ...
                        <div>
                            ...
                            <div>
                                <input type="text" id="PartyCode" name="PartyCode" placeholder="PartyCode" value="<?php echo set_value('PartyCode'); ?>" onfocus="this.select();" />
                            </div>
                            <div>
                                <input type=" text" id="PartyName" name="PartyName" tabindex="-1" readonly="" style="background: rgb(203, 203, 245);  width: 300px;" placeholder="PartyName" value="<?php echo set_value('PartyName'); ?>" />
                            </div>
                        ...
                        <script>
                            function changeCrDr() {
                                ...
                                document.getElementById("drCr").innerHTML = x + " A/c Code";
                            }
                        </script>

                        <div>
                            <label>Nature [Dr/Cr]</label>
                            <select style="border-color: white;box-shadow: inset .1px 0 0 .1px gray;" onchange=" changeCrDr()" onkeydown="focusnext(event)" name="Nature" id="Nature">
                        ...
                        <div> -->
                            ...
                            <input type="text" name="refnum" id="refnum" placeholder="Ref Number" onkeydown="focusnext(event)" />

                        </div>
                        <div>
                            <label>Gross Amt</label>
                            <input type="text" onkeydown="focusnext(event)" onkeyup="getNetAmt()" id="grossamt" name="grossamt" placeholder="Gross Amt" />
                        </div>
                        <div>
                            <label style="width: 130px;">Advance Amt</label>
                            <input type="text" onkeydown="focusnext(event)" onkeyup="getNetAmt()" id="adv_amt" name="adv_amt" placeholder="Advance Amount" />

                            <label style="width: 50px;">Lot No.</label>
                            <input type="text" onkeydown="focusnext(event)" id="lotno" name="lotno" placeholder="Lot Number" />
                            <!-- </div>
                        ...
                        <script>
                            ...
                            function getNetAmt() {
                                if (document.getElementById("grossamt").value != "") {
                                    ...
                                    if (document.getElementById("adv_amt").value == "")
                                        var adv_amt = 0;
                                    else
                        ...
                        <div> -->
                            ...
                            <input type="text" class="code" id="accode" name="a/c_code" placeholder="Account Code" style="width: 110px;" />
                            <input type="text" class="name" id="acname" name="a/c_Name" placeholder="Account Name" readonly style="background: rgb(203, 203, 245); width: 130px;" />

                        </div>
                        <div>
                            <label>Add Charges Amt</label>
                            <input type="text" name="addchargeamt" id="addchargeamt" placeholder="Add Charges" onkeydown="focusnext(event)" style="width: 110px; " />
                            <!-- </div>
                        <div> -->
                            ...
                            <input type="text" class="code" id="Addcode" name="Addcode" placeholder="Add Charges Code" style="width: 110px;" />
                            <input type="text" class="name" id="Addname" name="Addname" placeholder="Add Charges Name" readonly style="background: rgb(203, 203, 245);width: 130px;" />

                        </div>
                        <div>
                            <label>Less Chages Amt</label>
                            <input type="text" id="lessamt" name="lessamt" placeholder="Less Charges " onkeydown="focusnext(event)" style="width: 110px; ">
                            <!-- </div>
                        <div> -->
                            ...
                            <input type="text" class="code" id="Lesscode" name="Lesscode" placeholder="Less Charges Code" style="width: 110px;">
                            <input type="text" class="name" id="Lessname" name="Lessname" placeholder="Less Charges Name" readonly style="background: rgb(203, 203, 245); width: 130px;">
                        </div>
                        <div>
                            <label>Total T.D.S.</label>
                            <input type="text" onkeydown="focusnext(event)" id="Totaltds" name="Totaltds" placeholder="Total TDS Amount" style="background: rgb(203, 203, 245); width: 110px; ">
                            <!-- </div>
                        <div> -->
                            ...
                            <input type="text" class="code" id="Tdscode" name="Tdscode" placeholder="TDS Code" style="width: 110px;">
                            <input type="text" class="name" id="Tdsname" name="Tdsname" placeholder="TDS Name" readonly style="background: rgb(203, 203, 245); width: 130px;">
                        </div>
                    </fieldset>
                </div>
            ...
            <div class="sec1" style=" transform: translate(690px,-250px); padding-right: 50px;">
                ...
                <div class="tds-deducted">
                    <fieldset style="width: 45vw; height: 25vh;">
                        ...
                        <div>
                            <label>T.D.S.</label>
                            <input type="text" name="tdsrate" id="tdsrate" placeholder="TDS Rate" onkeydown="focusnext(event)" onkeyup="tdsAmtVal()">
                            <input type="text" name="tdsamt" id="tdsamt" placeholder="TDS Amount" onkeydown="focusnext(event)">
                        </div><br>
                        <div>
                            <label>E.Cess</label>
                            <input type="text" name="ecesrate" id="ecesrate" placeholder="E.cess Rate" onkeydown="focusnext(event)">
                            <input type="text" name="ecesamt" id="ecesamt" placeholder="E.cess Amount" onkeydown="focusnext(event)">
                        </div> <br>
                        <div>
                            <label>Surcharge </label>
                            <input type="text" name="surcrate" id="surcrate" placeholder="Surcharge Rate" onkeydown="focusnext(event)">
                            <input type="text" name="surcamt" id="surcamt" placeholder="Surcharge Amount" onkeydown="focusnext(event)">
                        </div> <br>
                        <label style="width: fit-content;">Reasons For Lower/Higher/No Ded</label>
                        <input type="text" name="reason" id="reason" onkeydown="focusnext(event)">
                    </fieldset>
                    ...
                    <div style="transform: translateY(-30px);">
                        <fieldset style="width: 50vw; height: 35vh;">
                            ...
                            <div style="display:flex; flex-direction:row; width:110%;">
                                <div style="width: 100%">
                                    <div>
                                        ...
                                        <input type="text" name="bank_amt" id="bank_amt" placeholder="Cash/Bank Amt" onkeydown="focusnext(event)" onkeyup="calcbankamt1()" />
                                    </div><br>
                                    <div>
                                        ...
                                        <input type="text" name="bank_code" id="bank_code" placeholder="Cash/Bank Code" />
                                        <input type="text" name="bank_name" id="bank_name" placeholder="Bank Name" readonly style="background: rgb(203, 203, 245); width: 250px;">
                                        <input type="text" id="Bank_Group" readonly style="background: rgb(203, 203, 245); width: 40px;"><br />

                                    </div>
                                    <div> <label>Cash/Bank Amt</label>
                                        <input type="text" name="bank_amt_1" id="bank_amt_1" placeholder="Cash/Bank Amt" onkeydown="focusnext(event)" />
                                    </div><br>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="bank_code_1" id="bank_code_1" placeholder="Cash/Bank Code" />
                                        <input type="text" name="bank_name_1" id="bank_name_1" placeholder="Bank Name" readonly style="background: rgb(203, 203, 245); width: 250px;">
                                        <input type="text" id="Bank_Group_1" readonly style="background: rgb(203, 203, 245); width: 40px;"><br />

                                    </div>

                                    <div>
                                        <label>Cheque No.</label>
                                        <input type="text" name="chq_no" id="chq_no" placeholder="Cheque No" onkeydown="focusnext(event)" />
                                    </div><br>

                                    <div>
                                        <label>UTR No.</label>
                                        <input type="text" name="utr" id="utr" placeholder="UTR No" onkeydown="focusnext(event)" style="width: 330px;" />
                                        Slip No.
                                        <input type="text" name="slip" id="slip" onkeydown="focusnext(event)" style="width: 40px;">
                            ...
                            <div>
                                ...
                                <input type="text" name="BankCode" placeholder="Bank Code" id="BankCode" style="width:100px;">
                                <input type="text" name="BankName" style="width: 200px;" placeholder="Bank Name" id="BankName" readonly style="background: rgb(203, 203, 245); width: 260px;">
                                <input type="text" name="BankBranch" style="width: 100px;" placeholder="Bank Branch" id="BankBranch" readonly style="background: rgb(203, 203, 245);">
                ...
                <div style="transform: translateY(-54px);">
                    <fieldset style="width: 45vw">
                        ...
                        <div>
                            ...
                            <input type="text" id="ChllanNo" name="ChallanNo" onkeydown="focusnext(event)">
                            <label style="width: 100px;">Challan Date</label>
                            <input type="date" name="Challan_date" id="Challan_date" onkeydown="focusnext(event)">
                        </div><br>
                        <div>
                            ...
                            <input type="text" name="TdsBankCode" style="width: 70px;" id="TdsBankCode" placeholder="Bank Code">
                            <input type="text" name="TdsBankName" style="width: 200px;" id="TdsBankName" placeholder="Bank Name" readonly style="width: 260px; background: rgb(203, 203, 245);">
                            <input type="text" name="TdsBankBranch" style="width: 100px;" id="TdsBankBranch" placeholder="Bank Branch" readonly style="background: rgb(203, 203, 245);">
                            <br>
                        </div>
                        <div>
                            <label>Cheque No.</label>
                            <input type="text" id="DepocheqNo" name="DepocheqNo" placeholder="Cheque No" onkeydown="focusnext(event)" style="width: 250px;">
                        </div>
            ...
            <!-- 
            <div class="sec1" style="transform:translate(700px,-120px)">
                <input type="button" id="AddTdsDet" value="Add" name="Add" style=" width:50px; cursor:pointer; " class="btn btn-success">
            </div>
-->
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    ...
                    <div class="modal-content">
                            ...
                            <div class="gst" style="display: flex; flex-direction:column; align-items: center; justify-content: center;">
                                ...
                                <div class="tds-deducted">
                                    ...
                                    <div><label>Invoice No.</label>
                                        <input type="text" name="InvoiceNumber" id="InvoiceNumber" onkeydown="focusNextInModal(event)" placeholder="Invoice Number">
                                    </div> <br>
                                    <div> <label>Invoice Date</label>
                                        <input type="date" id="InvoiceDate" onkeydown="focusNextInModal(event)" name="InvoiceDate" value="<?php echo $today; ?>">
                                    </div><br>
                                    <div>
                                        <label>GST % </label>
                                        ...
                                        <input type="text" id="TaxCode" name="TaxCode" placeholder="Tax Code">
                                        <input type="text" id="TaxRate" name="TaxRate" placeholder="Tax Rate" readonly>

                                    </div><br>
                                    <div>
                                        <label>MS/OMS</label>
                                        <input type="text" id="SaleType" placeholder="M/O" name="SaleType" maxlength=1 onkeypress='return  (event.charCode == 77 || event.charCode == 79) ' onkeydown="focusNextInModal(event)">
                                    </div> <br>
                                    <div>
                                        <label>HSN/SAC Code</label> <input type="text" id="hsncode" name="hsncode" placeholder="HSN Code" onkeydown="focusNextInModal(event)">
                                    </div><br>
                                    <div>
                                        <label>Taxable Amt</label>
                                        <input type="text" name="taxableamt" placeholder="Taxable Amount" id="taxableamt" onkeydown="focusNextInModal(event)">
                                    </div>
                                    <div style="background: rgb(203, 203, 245);">
                                        <label style="width: 5px; padding-left: 10px;">RCM</label>
                                        <input type="checkbox" style="padding-right: 10px;" name="rcm" id="rcm" onkeydown="focusNextInModal(event)"><br>
                                    </div><br>
                                    ...
                                    <input type="text" name="igstrate" id="igstrate" readonly>
                                    <br>
                                    <label>Amount</label>
                                    <input type="text" name="cgstamt" id="cgstamt" readonly>
                                    <input type="text" name="sgstamt" id="sgstamt" readonly>
                                    <input type="text" name="igstamt" id="igstamt" readonly>
                                    <br>
                                    <label style="width: 130px; padding-left: 0px;">
                                        Total Bill Amt</label>
                                    <input type="text" id="totalgstAmt" name="totalgstAmt" readonly>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" id="close" data-dismiss="modal" onkeydown="focusNextInModal(event)">Close</button>
    ...
    <script>
        ...
        function CRACCode($PartyCode, $PartyName) {
            document.getElementById("accode").value = $PartyCode;
            document.getElementById("acname").value = $PartyName;

        }

        function LessCode($PartyCode, $PartyName) {
            document.getElementById("Lesscode").value = $PartyCode;
            document.getElementById("Lessname").value = $PartyName;

        }

        function AddCode($PartyCode, $PartyName) {
            document.getElementById("Addcode").value = $PartyCode;
            document.getElementById("Addname").value = $PartyName;

        }

        function TdsCode($PartyCode, $PartyName) {
            document.getElementById("Tdscode").value = $PartyCode;
            document.getElementById("Tdsname").value = $PartyName;
        ...
        function TdsBankCode($BankCode, $BankName, $BankBranch) {
            document.getElementById("TdsBankCode").value = $BankCode;
            document.getElementById("TdsBankName").value = $BankName;
            document.getElementById("TdsBankBranch").value = $BankBranch;
        ...
        function CashCode($ACCode, $ACName, $GroupCode) {
            document.getElementById("bank_code").value = $ACCode;
            document.getElementById("bank_name").value = $ACName;
            document.getElementById("Bank_Group").value = $GroupCode;
        }

        function CashCode1($ACCode, $ACName, $GroupCode) {
            document.getElementById("bank_code_1").value = $ACCode;
            document.getElementById("bank_name_1").value = $ACName;
            document.getElementById("Bank_Group_1").value = $GroupCode;
        }
    </script>
    <script>
        $(document).ready(function() {
