<!-- <?php include 'header-form.php'; ?> -->
    ...
    <body onload="loadPrint();">
        ...
        <table id='taxReportTable' border="1">
            ...
            <tr>
                <td colspan='2'>
                    <div id="gst" style="font-weight: bold;margin-left: -20px;font-size : 10px">
                        <ul id="list">
                            ...
                            <li><?php if(isset($gst)) {echo $gst[0]->GSTNo;} ?></li>
                            <li><?php if(isset($gst)) {echo $gst[0]->FSLNo;} ?></li>
                        </ul>
                    </div>
                </td>
                <td colspan='5'>
                    <div style="text-align : center;">
                        <ul id="list">
                            ...
                            <li style="font-size: 250%;font-weight: bold;"><?php if(isset($company)) {echo $company[0]->CoName;} ?></li>
                            <li style="font-size: 125%;font-weight: bold;"><?php if(isset($company)) {echo $company[0]->address;} ?></li>
                            <li style="font-size: 125%;font-weight: bold;"><?php if(isset($company)) {echo $company[0]->phone;} ?>
                            <?php echo "\n"; ?>
                            <?php if(isset($company)) {echo $company[0]->FirmEmailID;} ?></li>
                        </ul>
                    </div>
                </td>
                <td colspan='3'>
                <div id="bank" style="font-weight: bold;margin-left: -20px;font-size : 10px">
                        <ul id="list">
                            ...
                            <li><?php if(isset($gst)) {echo $gst[0]->BankName;} ?></li>
                            <li><?php if(isset($gst)) {echo $gst[0]->BankBranch;} ?></li>
                            <li><?php if(isset($gst)) {echo $gst[0]->BankAccount;} ?></li>
                            <li><?php if(isset($gst)) {echo $gst[0]->BankIFSC;} ?></li>
                        </ul>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td colspan='3'>
                    <div id="bill-address" style="margin-left: -20px;">
                        <ul id="list">
                                <!-- Made change here using isset function -->
                            <li><?php if(isset($billingAddress)) {echo $billingAddress[0]->PartyName;} ?></li>
                            <li><?php if(isset($billingAddress)) {echo $billingAddress[0]->PartyAddressI;} ?></li>
                            <li><?php if(isset($billingAddress)) {echo $billingAddress[0]->PartyAddressII;} ?></li>
                            <li><?php if(isset($billingAddress)) {echo $billingAddress[0]->PartyAddressIII;} ?></li>
                            <li><?php if(isset($billingAddress)) {echo $billingAddress[0]->PartyArea;} ?></li>
                            <li><?php if(isset($billingAddress)) {echo $billingAddress[0]->PartyCity;} ?></li>
                            <li><?php if(isset($billingAddress)) {echo $billingAddress[0]->PartyState;} ?></li>
                            <li><?php if(isset($billingAddress)) {echo $billingAddress[0]->StateCode;} ?></li>
                        </ul>
                    </div>
                </td>
                <td colspan='4'>
                ...
                <td colspan='3'>
                    <div id="memo-details" style="margin-left: -10px; font-weight: bold;">
                        <ul id="list">
                                <!-- Made changes here using isset function  -->
                            <li>Invoice No. :<?php echo "&nbsp;"; ?><?php if(isset($debitMemo)) {echo $debitMemo[0]->BillNo;} ?></li>
                            <li>Date :<?php echo "&nbsp;"; ?><?php if(isset($debitMemo)) {echo date('d/m/Y', strtotime($debitMemo[0]->BillDate));} ?></li>
                            <li>LR No :<?php echo "&nbsp;"; ?><?php if(isset($debitMemo)) {echo $debitMemo[0]->LRNo;} ?></li>
                            <li>PAN No. :<?php echo "&nbsp;"; ?><?php if(isset($debitMemo)) {echo $debitMemo[0]->PartyPANo;} ?></li>
                            <li>&nbsp;</li>
                            <li>&nbsp;</li>
                            <li>&nbsp;</li>
                            <li>&nbsp;</li>
            ...
            <tr>
                        <!-- Made changes here using isset function  -->
                <td colspan='3'><div id="gsttin" style="margin-left: 10px;font-weight: bold;"><?php if(isset($broker)) {echo $broker[0]->PartyGSTNo;} ?></div></td>
                <td colspan='5'><div id="fssai" style="margin-left: 10px;font-weight: bold;"><?php if(isset($broker)) {echo $broker[0]->PartyFSLNo;} ?><?php echo "\n\n|\n\n"; ?><?php if(isset($broker)) {echo date('d/m/Y', strtotime($broker[0]->PartyFSLDate));} ?></div></td>
                <td colspan='2'><div id="broker" style="margin-left: 10px;font-weight: bold;"><?php if(isset($broker)) {echo $broker[0]->BrokerTitle;} ?></div></td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="2" rowspan="2">
                    <div id="pack-detail" style="margin-left: -30px; font-weight: bold;">
                        <ul id="list">
                            <li>Gross Amount</li>
                ...
                <td rowspan="2">
                    <div id="pack-charge" style="text-align: right;margin-right: 10px;">
                        <ul id="list">
                            ...
                            <li><?php if(isset($calculate)) {echo $calculate[0]->GrossAmt;} ?></li>
                            <li><?php if(isset($calculate)) {echo $calculate[0]->ContAmt;} ?></li>
                            <li><?php if(isset($calculate)) {echo $calculate[0]->DiscountAmt;} ?></li>
                            <!-- <li><?php echo $calculate[0]->HelMajuri; ?></li> -->
                            <li><?php if(isset($calculate)) {echo $calculate[0]->APMCChrg;} ?></li>
                            <li><?php if(isset($calculate)) {echo $calculate[0]->CGSTAmt;} ?></li>
                            <li><?php if(isset($calculate)) {echo $calculate[0]->SGSTAmt;} ?></li>
                            <li><?php if(isset($calculate)) {echo $calculate[0]->IGSTAmt;} ?></li>
                            <li>0.00</li>
                            <li><?php if(isset($calculate)) {echo $calculate[0]->RoffAmt;} ?></li>
                        </ul>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="6">
                    <ul id="list" style="margin-left: -40px;">
                        ...
                        <li>PAYMENT <?php if(isset($goDown)) {echo $goDown[0]->GodownDesc;} ?> PAYMENT WITHIN 15 DAYS</li>
                        <li>Final Bill Amount : <?php if(isset($calculate)) {echo $calculate[0]->BillAmt;} ?></li>
                    </ul>
                </td>
                <td style="text-align: center;"><?php if(isset($goDown)) {echo $goDown[0]->GodownDesc;} ?></td>
                <td colspan="2"><div style="margin-left: 10px;">Total :</div></td>
                <td colspan="1"><div style="text-align: right;margin-right: 10px;"><?php if(isset($calculate)) {echo $calculate[0]->BillAmt;} ?></div></td>
            </tr>

            <tr>
                <td colspan="7"></td>
                <td colspan="3"><div style="text-align: right;font-weight: bold;margin-right: 10px;">FOR <?php if(isset($company)) {echo $company[0]->CoName;} ?></div></td>
            </tr>
            ...
            <tr>
                <td colspan="5">
                    <div id="delivery-1">
                        <ul id="list">
                            <li><?php if(isset($company)) {echo $company[0]->CoName;} ?></li>
                            <li><?php if(isset($billingAddress)) {echo $billingAddress[0]->PartyName;} ?></li>
                            <li><?php if(isset($billingAddress)) {echo $billingAddress[0]->PartyArea;} ?></li>
                            <li><?php if(isset($broker)) {echo $broker[0]->BrokerTitle;} ?></li>
                        </ul>
                    </div>
                </td>
                <td colspan="5">
                    <div id="delivery-2">
                        <ul id="list">
                            <li>Delivery :<?php if(isset($goDown)) {echo $goDown[0]->GodownDesc;} ?></li>
                            <li>Invoice No. :<?php if(isset($debitMemo)) {echo $debitMemo[0]->BillNo;} ?></li>
                            <li>Date :<?php if(isset($debitMemo)) {echo date('d/m/Y', strtotime($debitMemo[0]->BillDate));} ?></li>
                            <li>LR NO. :<?php if(isset($debitMemo)) {echo $debitMemo[0]->LRNo;} ?></li>
                        </ul>
                    </div>
                </td>
            </tr>
