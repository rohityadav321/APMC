            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <input style="height: inherit;" type="text" class="form-control" id="Qty" onkeydown="calculateCharges(event);" name="Qty" value="<?php echo set_value('Qty'); ?>" placeholder="Qty" onfocus="this.select();">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  ...
                  <script type="text/javascript">
                    ...
                    var idarray = ["GodownI", "LotNo", "ItemCode", "Qty", "GrossWt", "NetWt", "Rate", "APMCIn", "ETaxIn", "ContChrg", "DiscDetRate", "TCSPer", "Save"];
                    ...
                    function x28062021calculateDiscount() {
                      if (document.getElementById("DiscDetRate").value != "") {
                        var disc = document.getElementById("DiscDetRate").value;
                        var itemAmt = document.getElementById("GrAmt").value;
                        var discAmt = (itemAmt * disc) / 100;
