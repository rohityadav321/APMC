<!DOCTYPE html>
    <head>
        ...
        <!-- ajax and datatables javascripts and css links -->
        ...
        <script>
            //displays table names - fetched from database
            function showTables(tableName) {
                var url = "<?=base_url()?>index.php/Csv_import/displaySampleTable/"+tableName;
                location.href=url;
            }

            //csv & excel buttons for downloading sample data
    ...
    <body>
        ...
        <div id="rules">
            ...
            <div id="demo">
                <?php   
                    //creates table for sample data fetched from database   
