                             ...
                             <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input 
                                          ...
                                          name="IDNumber"
                                          value="<?php echo $Rojdata[0]->DocNo;?>"
                                          placeholder="Id" 
                                          readonly >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2">
                                        <input style="width: 100%;"
                                          ...
                                          tabindex="5"
                                          onkeydown="focusnext(event)"
                                          value="<?php echo $Rojdata[0]->BookCode;?>"
                                          placeholder="">
                                    ...
                                    <input style="margin-left:-25px; width: 100%;"
                                          ...
                                          tabindex="5"
                                          onkeydown="focusnext(event)"
                                          value="<?php echo $Rojdata[0]->ACTitle;?>"
                                          placeholder="" 
                                          readonly>
                                    ...
                                    <input style="margin-left:-50px;width: 100%;"
                                          ...
                                          tabindex="6"
                                          onkeydown="focusnext(event)"
                                          value="<?php echo $Rojdata[0]->GroupCode;?>"
                                          placeholder=""
                                          readonly>
                              ...
                              <div class="form-group row" style = "margin-right: -50%; align-content: right">
                                    ...
                                    <div class="col-md-3">
                                        <select 
                                          ...
                                          id="Nature"
                                          onkeydown="focusnext(event)"
                                          value="<?php echo $Rojdata[0]->AMTNature;?>" 
                                          tabindex="8"
                                          placeholder="Nature">
