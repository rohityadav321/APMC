    ...
    <div class="card border-dark">
      <div class="card-header border-dark">
        <center>
          ...
          <a style="float: right;background-color:#3b5998;border-color:#AED6F1;" id="printInvoice" class="btn btn-success mr-2" tabindex="-1" target="_blank" href="<?php echo base_url() . "index.php/SalesController/getInvoiceData/" . $Loaded_List[0]->BillNo; ?>">
            Print Invoice
          </a>
          &nbsp;
          <?php
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  ...
                  <td><input style="height: inherit;" type="text" class="form-control" id="Qty" onkeydown="focusnext(event)" name="Qty" onblur="calculateCharges();" value="<?php echo $SalesDList0 == 1 ? set_value('Qty', $SalesDList[0]->Qty) : set_value('Qty'); ?>" placeholder="Qty" onfocus="this.select();">
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <tr>
              ...
              <td>&nbsp;</td>
              <td class="firstTable">
                <input readonly style="float: right;width: 15px;padding:1px;background-color:blue;border-color:blue;" class="btn btn-success mr-2" type="submit" name="Add" id="Add" value="U" tabindex="-1">
              </td>
