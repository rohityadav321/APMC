...
<head>
    ...
    <script type="text/javascript">
        ...
        function SupplyCode($Acccode, $acname, $groupcode, $brokercode, $BrokerTitle, $GSTNo) {
        ...
        // Updating data in Garu Purchase Header Table when Enter Key Pressed
        $(document).ready(function() {
            $('#BrokerCode').keydown(function(e) {
                ...
                if (code == 13 || code === 9) {
                    ...
                    $.ajax({
                        url: "<?= base_url() ?>index.php/NewGaruPurController/garuPurchaseHeaderUpdate",
                        data: {
                        ...
                        success: function(savingStatus) {
                            alert("Data Updated in PurHeader Table");
        ...
        // Updating data in Garu Purchase Header Table when Save Button Clicked
        function saveGaruPurHeader() {
            var RefIDNumber = $('#RefIDNumber').val();
            var GoodsRcptDate = $('#GoodsRcptDate').val();
            var InvoiceNo = $('#InvoiceNo').val();
            var InvoiceDate = $('#InvoiceDate').val();
            ...
            $.ajax({
                ...
                cache: false,
                success: function(savingStatus) {
                    alert("Data Updated in PurHeader Table on Save Button");
            ...
            $('#GaruPurEditDetails').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        $('#cgstAmt').text(result[0]['CGSTAmt']);
                        $('#sgstAmt').text(result[0]['SGSTAmt']);
                        $('#igstAmt').text(result[0]['IGSTAmt']);
                        ...
                        // Enable the Garu Purchase Header Part
                        var nodes = document.getElementById("garuPurHeader").getElementsByTagName('*');
                        for (var i = 0; i < nodes.length; i++) {
                            nodes[i].disabled = false;
                        }
        ...
        // Saving data in Garu Purchase Details Table on click of Enter Key (NetPayable)
        $(document).ready(function() {
            $('#GaruPurInsertDetails').click(function() {
                ...
                $.ajax({
                    url: "<?= base_url() ?>index.php/NewGaruPurController/garuPurchaseDetailsInsert1",
                    data: {
                        IDNumber: IDNumber,
                        StateCode: StateCode,
                        GoodsRcptDate: GoodsRcptDate,
        ...
        function isupdateconfirm(id) {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $UOM = result[0]['Units'];
                    $UsualRate = result[0]['Rate'];
                    $UsualRatePer = result[0]['UsualRatePer'];
                    $Packing = result[0]['Packing'];
                    $GST_P = result[0]['TaxRate'];
                    $APMCTax = result[0]['APMCTax'];
                    $APMCSChrg = result[0]['APMCSChrg']


                    ItemC($ItemCode, $ItemName, $UOM, $UsualRate, $UsualRatePer, $Packing, $GST_P, $APMCTax, $APMCSChrg);
        ...
        // Delete recorde form PurDetails Table on click of Delete Button
        ...
        <div class="card border-dark">
            <div class="card-header border-dark">
                <center>
                    ...
                    <a style="float: right;" id="cancel" accesskey="b" class="btn btn-danger" tabindex="-1" href="<?php echo base_url() . "index.php/NewGaruPurController/show/" ?>">Back (Alt+B)</a>
                    &nbsp;
                    <a style="float: right;" id="Save" accesskey="s" class="btn btn-success" tabindex="-1" onclick="saveGaruPurHeader()">Save (Alt+S)</a>
                    &nbsp;
                    <a style="float: right;background-color:blue;border-color:blue;" id="addItem" class="btn btn-success" tabindex="-1" onclick=addNewItem()>Add Item</a>
                    &nbsp;
                    <h4 style="float: left;">Garu Purchase (Edit Item for ID <?php echo $Loaded_List[0]->RefIDNumber; ?>)</h4>
                        ...
                        <div class="col-sm-7" id="garuPurHeader" style="margin-left:-38px;">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input style="margin-left:-40px;" type="text" class="form-control" id="RefIDNumber" tabindex="1" onkeydown="focusnext(event)" name="RefIDNumber" value="<?php echo set_value('RefIDNumber', $Loaded_List[0]->RefIDNumber); ?>" placeholder="Id" readonly>
                                        <span class="text-danger"><?php echo form_error('RefIDNumber'); ?>
                                        </span>
                                    </div>

                                    <div class="col-sm-4">
                                        <input style="margin-left:-65px;width: 128%; font-size:x-small;" type="date" class="form-control" id="GoodsRcptDate" tabindex="2" onkeydown="focusnext(event)" name="GoodsRcptDate" value="<?php echo set_value('GoodsRcptDate', date_format(date_create($Loaded_List[0]->GoodsRcptDate), 'Y-m-d')); ?>" placeholder="GoodsRcptDate" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input style="margin-left:-40px;width: 100%;" type="text" class="form-control" id="InvoiceNo" tabindex="3" onkeydown="focusnext(event)" name="InvoiceNo" value="<?php echo set_value('InvoiceNo', $Loaded_List[0]->InvoiceNo); ?>" placeholder="Invoice No" onfocus="this.select();">
                                        <span class="text-danger"><?php echo form_error('InvoiceNo'); ?>
                                        </span>
                                    </div>

                                    <div class="col-sm-4">
                                        <input style="margin-left:-65px;width: 128%; font-size:x-small;" type="date" class="form-control" id="InvoiceDate" tabindex="4" onkeydown="focusnext(event)" name="InvoiceDate" value="<?php echo set_value('InvoiceDate',  date_format(date_create($Loaded_List[0]->InvoiceDate), 'Y-m-d')); ?>" placeholder="Id">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input style="margin-left:-40px;width: 100%;" type="text" class="form-control" id="LRNo" name="LRNo" tabindex="5" onkeydown="focusnext(event)" value="<?php echo set_value('LRNo', $Loaded_List[0]->LRNo); ?>" placeholder="LR/RR Number" onfocus="this.select();">
                                    ...
                                    <div class="col-sm-4">
                                        <input style="margin-left:-65px;width: 128%; font-size:x-small;" type="date" class="form-control" id="LRDate" name="LRDate" onkeydown="focusnext(event)" tabindex="6" value="<?php echo set_value('LRDate', date_format(date_create($Loaded_List[0]->LRDate), 'Y-m-d')); ?>" placeholder="Id">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input style="margin-left:45px;width: 105%;" type="text" class="form-control" id="TransChg" name="TransChg" onkeydown="focusnext(event)" tabindex="7" value="<?php echo set_value('TransChg', $Loaded_List[0]->TransportCharges); ?>" placeholder="0.00" onfocus="this.select();">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6" style="margin-left:-60px;">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="DespatchFrom" onkeydown="focusnext(event)" tabindex="8" name="DespatchFrom" onblur="moveCursorTo()" value="<?php echo set_value('DespatchFrom', $Loaded_List[0]->DespatchFrom); ?>" placeholder="From" onfocus="this.select();">
                                        <span class="text-danger"><?php echo form_error('DespatchFrom'); ?></span>
                                    </div>

                                    <div class="col-sm-4">
                                        <input style="margin-left:-25px;width:180px;" type="text" class="form-control" id="DespatchTitle" name="DespatchTitle" readonly="" placeholder="From Title" tabindex="-1" value="<?php echo set_value('DespatchTitle', $Loaded_List[0]->DespatchTitle); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="DespatchTo" onkeydown="focusnext(event)" tabindex="9" name="DespatchTo" onblur="moveCursorSupplier()" value="<?php echo set_value('DespatchTo', $Loaded_List[0]->DespatchTo); ?>" placeholder="To" onfocus="this.select();">
                                    ...
                                    <div class="col-sm-4">
                                        <input style="margin-left:-25px;width:180px;" type="text" class="form-control" id="DespatchToTitle" readonly="" name="DespatchToTitle" placeholder="To Title" tabindex="-1" value="<?php echo set_value('DespatchToTitle', $Loaded_List[0]->DespatchToTitle); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="PartyCode" onkeydown="focusnext(event)" name="PartyCode" tabindex="10" onblur="moveCursorBroker()" value="<?php echo set_value('PartyCode', $Loaded_List[0]->PartyCode); ?>" placeholder="SCode" onfocus="this.select();">
                                        <span class="text-danger"><?php echo form_error('PartyCode'); ?></span>
                                    </div>

                                    <div class="col-sm-4">
                                        <input style="margin-left:-25px;width:180px;" type="text" class="form-control" id="PartyName" readonly="" name="PartyName" placeholder="Supplier Title" tabindex="-1" value="<?php echo set_value('PartyName', $Loaded_List[0]->PartyName); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="BrokerCode" name="BrokerCode" tabindex="11" onkeydown="focusnext(event)" value="<?php echo set_value('BrokerCode', $Loaded_List[0]->BrokerCode); ?>" placeholder="Broker" onfocus="this.select();">
                                        <span class="text-danger"><?php echo form_error('BrokerCode'); ?></span>
                                    </div>

                                    <div class="col-sm-4">
                                        <input style="margin-left:-25px;width:180px;" type="text" class="form-control" id="broker_title" name="broker_title" readonly="" placeholder="Broker Title" tabindex="-1" value="<?php echo set_value('broker_title', $Loaded_List[0]->BrokerTitle); ?>">
                                        <span class="text-danger"><?php echo form_error('broker_title'); ?></span>
                                    </div>


                                    <div class="col-sm-4">
                                        <input style="margin-left:-25px;width:180px;" type="text" class="form-control" id="GstNo" name="GstNo" readonly="" placeholder="GstNo" tabindex="-1" value="<?php echo set_value('GstNo', $GstNo[0]->GSTNo); ?>" hidden>
                                        <span class="text-danger"><?php echo form_error('GstNo'); ?></span>
                                    </div>


                                    <div class="col-sm-4">
                                        <input style="margin-left:-25px;width:180px;" type="text" class="form-control" id="StateCode" name="StateCode" readonly="" placeholder="StateCode" tabindex="-1" value="<?php echo set_value('StateCode', $StateCode[0]->StateCode); ?>" hidden>
                                        ...
                                        <table id="footer1" class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="10" style="font-size: 12px;" id="totalQty"><?php echo $Total[0]->TotalQty; ?></td>
                                                </tr>

                                                <tr>
                                                    <td class="blue text-right" style="font-size: 12px;text-align: left!important;"><b>Total Amount &nbsp;</b></td>
                                                    <td width="10" class="bgblue" style="font-size: 12px;" id="totalAmt"><?php echo $Total[0]->TotalAmount; ?></td>
                                                </tr>

                                                <tr>
                                                    <td class="text-right" style="font-size: 12px;text-align: left!important;"><b>Container Charge </b></td>
                                                    <td width="10" style="font-size: 12px;" id="contChg"><?php echo $Total[0]->ContainerCharge; ?></td>
                                                </tr>

                                                <tr>
                                                    <td class="text-right" style="font-size: 12px;text-align: left!important;"><b>APMC Charge &nbsp;</b></td>
                                                    <td width="10" style="font-size: 12px;" id="apmcChg"><?php echo $Total[0]->APMCCharge; ?></td>
                                                </tr>

                                                <tr>
                                                    <td class="text-right" style="font-size: 12px;text-align: left!important;"><b>Other Charges 1 </b></td>
                                                    <td width="10" style="font-size: 12px;" id="othChg1"><?php echo $Total[0]->OtherCharge1; ?></td>
                                                </tr>

                                                <tr>
                                                    <td class="blue text-right" style="font-size: 12px;text-align: left!important;"><b>Taxable Amount &nbsp;</b></td>
                                                    <td width="10" class="bgblue" style="font-size: 12px;" id="taxAmt"><?php echo $Total[0]->TaxableAmount; ?></td>
                                                </tr>
                                        ...
                                        <table id="footer1" class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="font-size: 12px;width:50%;" id="gstAmt" hidden><?php echo $Total[0]->TaxCharge; ?></td>
                                                </tr>

                                                <tr>
                                                    <td class="text-right" style="font-size: 12px;text-align: left!important;"><b>CGST Amount&nbsp;</b></td>
                                                    <td style="font-size: 12px;width:50%;" id="cgstAmt">
                                                        <?php
                                                        if ($Total[0]->StateCode === "27") {
                                                            echo number_format($Total[0]->TaxChargeBreakUp, 2, '.', '');
                                                        } else {
                                                            echo "0.00";
                                                        }
                                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="font-size: 12px;width:50%;" id="sgstAmt">
                                                        <?php
                                                        if ($Total[0]->StateCode === "27") {
                                                            echo number_format($Total[0]->TaxChargeBreakUp, 2, '.', '');
                                                        } else {
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="font-size: 12px;width:50%;" id="igstAmt">
                                                        <?php
                                                        if ($Total[0]->StateCode != "27") {
                                                            echo number_format($Total[0]->TaxChargeBreakUp, 2, '.', '');
                                                        } else {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="bgblue" style="font-size: 12px;width:50%;" id="grossAmt"><?php echo $Total[0]->GrossAmounts; ?></td>
                                                </tr>

                                                <tr>
                                                    <td class="blue text-right" style="font-size: 12px;text-align: left!important;"><b>TCS Amount &nbsp;</b></td>
                                                    <td class="bgblue" style="font-size: 12px;width:50%;" id="tcsAmt"><?php echo $Total[0]->TCSAmount; ?></td>
                                                </tr>

                                                <tr>
                                                    <td class="text-right" style="font-size: 12px;text-align: left!important;"><b>Other Charges 2 </b></td>
                                                    <td style="font-size: 12px;width:50%;" id="othChg2"><?php echo $Total[0]->OtherCharge2; ?></td>
                                                </tr>

                                                <tr>
                                                    <td class="blue text-right" style="font-size: 12px;text-align: left!important;"><b>Net Payable &nbsp;</b></td>
                                                    <td class="bgblue" style="font-size: 12px;width:50%;" id="netPay"><?php echo $Total[0]->NetPayables; ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table class="table table-bordered" style="border: none;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="border: none;">
                                            <input style="width:90px;" type="text" id="rates" name="rates" onblur="calculateAmt();" onkeydown="focusnext(event)" value="<?php echo set_value('rates'); ?>" class="form-control" readonly>
                            ...
                            <table class="table table-bordered" style="border: none;margin-top:-15px;">
                                <thead>
                                    <tr class="yellow">
                                        <th style="border: none; text-align:right; ">Total Amt</th>
                                        ...
                                        <th style="border: none;background-color:#a6b6e0;">
                                            <input style="float: right;width: 15px;margin-left:-10px;padding:0px;background-color:blue;border-color:blue;" class="btn btn-success  mr-2" type="button" name="GaruPurInsertDetails" id="GaruPurInsertDetails" value="A" tabindex="-1">
                                        </th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="border: none;">
                                            <input style="width:90px;" type="text" class="form-control" id="TCSAmount" name="TCSAmount" value="<?php echo set_value('TCSAmount'); ?>" onkeydown="focusnext(event)" readonly>
                                        </td>

                                        <td style="border: none;">
                                            <input style="width:90px;" type="text" class="form-control" id="NetPayable" name="NetPayable" value="<?php echo set_value('NetPayable'); ?>" onkeydown="focusnext(event)" readonly>
                                        ...
                                        <tr class="blue">
                                            <td id="widthh">
                                                <div style="text-align:center;">
                                                    ...
                                                    <button class="btn btn-warning btn-xs" onclick="isupdateconfirm(<?php echo $TableData[$i]->ID ?>);">
                                                        <i class="glyphicon glyphicon-pencil"></i>
                                                    </button>

                                                    <a class="btn btn-danger btn-xs" style="color:white;" onclick="isdeleteconfirm(<?php echo $TableData[$i]->ID ?>);">
                                            ...
                                            <td class="text-right"><?php echo $TableData[$i]->UsualRatePer; ?></td>
                                            ...
                                            <td class="text-right"><?php echo $TableData[$i]->TCSAmount; ?></td>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a data-dismiss="modal" id="closeAccount" href="javascript:void(0);" onclick="GodownCode('<?php echo $List->GodownID; ?>','<?php echo $List->GodownDesc; ?>'); ">
