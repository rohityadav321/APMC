              ...
              // function updateSalesHeader(){
                $('#AddNewEntry').keydown(function(e) {
                  ...
                  if(code == 13 || code === 9) {
                    ...
                    var BillText1 = $('#BillText1').val();
                    var BillText2 = $('#BillText2').val();
                    var NBrokRate = $('#NBrokRate').val();
   ...
   <body>
      ...
      <div class="container-fluid">
        ...
        <div class="card-header border-dark">
                ...
                <a style="float: right;" accesskey="a" 
                          class="btn btn-success mr-2"  
                          href= "<?php echo base_url() . "index.php/SalesController/show/" ?>"
                          tabindex="-1">Save(Alt+A)</a>
           ...
           <td><input 
            ...
            <td><input 
                ...
                >
                  ...
                  id="PackingCharge"
                  name="PackingCharge"                                                              
                  value="<?php echo $SalesDList0 == 1 ? set_value('PackingCharge',$SalesDList[0]->PackingChrg) : set_value('PackingCharge');?>"
                  >
                  ...
                  <input
                    ...
                    id="GrossWtOrginal"
                    name="GrossWtOrginal"
                    value="<?php echo $SalesDList0 == 1 ? set_value('GrossWtOrginal',$SalesDList[0]->Packing) : set_value('GrossWtOrginal');?>"
                    >
              </td>
            ...
            <td><input 
                  ...
                  <input
                    ...
                    id="Weight"
                    name="Weight"
                    value="<?php echo $SalesDList0 == 1 ? set_value('Weight',$SalesDList[0]->Weight) : set_value('Weight');?>">
                  </td>
            ...
            <div class="col-sm-12" style="padding-left: 20px; padding-right: 20px">
               <table style="width:100%;">
                  <tr>
                      ...
                      <td class="firstTable"><input 
                           type="text"
                           value="<?php echo $SalesDList0 == 1 ? set_value('Packing',$SalesDList[0]->Packing) : set_value('Packing');?>"
                           id="Packing"
                           name="Packing"
                           placeholder="Packing"
                           readonly
                      ...
                      <td class="firstTable"><input 
                           type="text"
                           id="PackingT"
                           value="<?php echo $SalesDList0 == 1 ? set_value('PackingT',$SalesDList[0]->PackingText) : set_value('PackingT');?>"
                           name="PackingT"
              ...
              <tbody>
                ...
                <tr>
                      ...
                      <input 
                          ...
                          type="text" 
                          style="outline: none;border: none;border-color: transparent;text-align:right;"
                          value="<?php echo $SalesDList0 == 1 ? set_value('DiffAmt5',$SalesDList[0]->BillText1) : set_value('BillText1','0.00'); ?>"
                          value="0.00"
                          >
                      </td>
                      </tr>
                      ...
                      <input 
                          ...
                          type="text" 
                          style="outline: none;border: none;border-color: transparent;text-align:right;"
                          value="<?php echo $SalesDList0 == 1 ? set_value('DiffAmt5',$SalesDList[0]->BillText2) : set_value('BillText2','0.00'); ?>"
                          >
                      </td>
                      </tr>
                      ...
                      <input 
                          ...
                          type="text" 
                          style="outline: none;border: none;border-color: transparent;text-align:right;"
                          value="<?php echo $SalesDList0 == 1 ? set_value('DiffAmt5',$SalesDList[0]->NBrokRate) : set_value('NBrokRate','0.00'); ?>"
                          >
                      </td>
