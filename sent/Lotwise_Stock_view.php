...
<head>
    <title>LotNo wise Stock Report </title>
    ...
    <div class="main">
        <div class="headernav">
            ...
            <div style="position:relative; margin-left:10px; margin-top:10px;">
                ...
                <form class="form" method='post' action='<?php echo base_url() ?>index.php/TBReportController/Lotwise_Stockshow'>
                    <b style="margin-right:20px">Lot No wise Stock</b>
