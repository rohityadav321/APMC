                                  ...
                                  <table>
                                        ...
                                        <tr>
                                          ...
                                          <td class="firstTable"><input
                                                ...
                                                autofocus
                                                name="BillDate"
                                                onkeydown="focusnext(event)" value="<?php echo set_value('BillDate', $today); ?>"
                                        ...
                                        <tr>
                                            ...
                                            <td class="firstTable" colspan="4">
                                              <input
                                                ...
                                                name="GodownID" placeholder="GodownID"
                                                onfocus="this.select();">
                                          ...
                                          <tr>
                                            ...
                                            <td class="firstTable">
                                              <input
                                                ...
                                                class="col-sm-5"
                                                id="MudiBazar"
                                                value="<?php echo set_value('MudiBazar', 'Y'); ?>"
                                                onkeydown="focusnext(event)"
                                                name="MudiBazar"
                                                onfocus="this.select();">
                                            ...
                                            <td class="firstTable"><input
                                                ...
                                                id="EWayBillNo"
                                                name="EWayBillNo"
                                                value="<?php echo set_value('EWayBillNo'); ?>"
                                                onkeydown="focusnext(event)"
                                        ...
                                        <tr>
                                          ...
                                          <td class="firstTable"><input
                                                ...
                                                onkeydown="focusnext(event)"
                                                id="DeliDate"
                                                value="<?php echo set_value('DeliDate', $today); ?>"
                                                name="DeliDate">
                                  ...
                                  <table>
                                      <tr>
                                        ...
                                        <td class="firstTable" colspan="3">
                                          <input
                                              ...
                                              type="text"
                                              id="DebtorID"
                                              value="<?php echo set_value('DebtorID'); ?>"
                                              name="DebtorID"
                                      ...
                                      <tr>
                                        ...
                                        <td class="firstTable" colspan="3">
                                          ...
                                          <input
                                              ...
                                              id="CPName"
                                              style="width: 55%"
                                              value="<?php echo set_value('CPName'); ?>"
                                              name="CPName"
                                      ...
                                      <tr>
                                        ...
                                        <td class="firstTable" colspan="2">Sale Type
                                          <input
                                                ...
                                                id="SaleType"
                                                onkeydown="focusnext(event)"
                                                value="<?php echo set_value('SaleType'); ?>"
                                                name="SaleType"
                                      ...
                                      <tr>
                                            ...
                                            <td class="firstTable" colspan="3">
                                                  <input
                                                          ...
                                                          type="text"
                                                          id="BrokerID"
                                                          value="<?php echo set_value('BrokerID'); ?>"
                                                          name="BrokerID"
                                                  ...
                                                  <input
                                                        ...
                                                        name="BrokerTitle"
                                                        readonly
                                                        value="<?php echo set_value('BrokerTitle'); ?>"
                                      ...
                                      <tr>
                                        ...
                                        <td class="firstTable">
                                            ...
                                            type="text"
                                            id="HelMajuri"
                                            value="<?php echo set_value('HelMajuri',0); ?>"
                                            onkeydown="focusnext(event)"
                                            name="HelMajuri"
                                        ...
                                        <td class="firstTable">
                                            ...
                                            id="OtherChrgs"
                                            onkeydown="focusnext(event)"
                                            value="<?php echo set_value('OtherChrgs',0); ?>"
                                            name="OtherChrgs"
                              ...
                              <tr>
                                    ...
                                    <td class="firstTable"> 
                                      ...
                                      <input style="float: right;width: 15px;padding:1px;background-color:blue;border-color:blue;" 
                                              ...
                                              accesskey="a" name="Save" id="Save" value="A"  tabindex="-1">
                                    </td>
