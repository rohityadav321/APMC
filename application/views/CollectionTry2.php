      ...
      <script type="text/javascript">
        ...
        $(document).ready(function() {
          ...
          if(mode == "C")
          {
            ...
            // document.getElementsByName("ChequeAmt")[0].placeholder = 0;
          ...
          else if(mode == "B")
          {
            ...
            // document.getElementsByName("CashAmt")[0].placeholder = 0;
...
<!-- 
                    <a style="float: right; margin-right:5px" 
                        ...
                        href= "<?php echo base_url() . "index.php/CollectionController/DeleteFromGrid/" . $ItemList[0]->IDNumber?>" >
                        Cancel (Alt+C)
                    </a>
-->
                    &nbsp;                  
                    ...
                    <a style="float: right; margin-right:5px" 
                        ...
                        tabindex="-1" 
                        target="_blank" 
                        href="<?php echo base_url() . "index.php/CollectionController/PrintReceipt/" . $TableData[0]->IDNumber; ?>" >
                        Print Receipt (Alt+P)
                    </a>
                    &nbsp;
              ...
              <table>
                ...
                <tr>
                  ...
                  <td><input
                              ...
                              id="CollectDate"
                              name="CollectDate"
                              value="<?php echo set_value('CollectDate', date_format(date_create($ItemList[0]->CollectDate),"Y-m-d")); ?>"
                ...
                <tr>
                  <td>Mode</td>
                  <td><select class="btn btn-primary dropdown-toggle" id="Mode" name="Mode" onkeydown="focusnext(event)" onchange="checkMode()" value="<?php echo set_value('Mode', $Mode[0]->Mode); ?>">

                          <option value="C" <?php if($Mode[0]->Mode=="C") echo 'selected="selected"'; ?>>Cash</option>
                          <option value="B" <?php if($Mode[0]->Mode=="B") echo 'selected="selected"'; ?>>Bank</option>
                          <option value="O" <?php if($Mode[0]->Mode=="O") echo 'selected="selected"'; ?>>Both</option>
      ...
      <div class="modal-content">
        ...
        <div class="form-group row">
                  ...
                  <div class="col-sm-3">
                    ...
                    name="ChqDate"
                    onkeydown="focusNextBox(event)"
                    value="<?php echo set_value('ChqDate', $ItemList[0]->CollectDate); ?>"
                    <span class="text-danger"><?php echo form_error('ChqDate'); ?></span>
                  </div>
        </div>

        <!-- value="<?php echo set_value('ChqDate', $today); ?>"> -->
