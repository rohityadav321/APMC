...
<body>
    <div class="container-fluid">
        ...
        <div style="position:relative; margin-left:175px; margin-top:10px;">
            <form method='post' action='<?php echo base_url() ?>index.php/CheckReturnController/show'>
        ...
        <div class="col-lg-12 text-right">
            <a class="btn btn-success" accesskey="a" href="<?php echo base_url() ?>index.php/CheckReturnController/add/">
        ...
        <table id="example" class="display text-right" style="width:100%">
            ...
            <tbody>
                <?php
                $totalRecord = count($CheqRet[0]);
                // echo $totalRecord;

                if ($CheqRet[0][0] == "empty") {
                    // echo "No data found";
                } else {
                ...
                ?>
                        <tr>
                            <td>
                                <a onclick="isupdateconfirm();" href="<?php echo base_url() . "index.php/CheckReturnController/Edit/" . $CheqRet[0][$i]['RefIDNumber']; ?>">
                                    <button class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-pencil"></i></button>
                                </a>
                                &nbsp;
                                <a onclick="isdeleteconfirm();" href="<?php echo base_url() . "index.php/CheckReturnController/DeleteCheque/" . $CheqRet[0][$i]['RefIDNumber']; ?>">
                                    <button class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-remove"></i></button>
                                </a>
                                &nbsp;
                                <!-- <a onclick="isprintconfirm();" target="_blank" href="<?php echo base_url() . "index.php/CollectionController/PrintFromGrid/" . $CheqRet[0][$i]['IDNumber']; ?>"> -->
                                <!-- <a onclick="isprintconfirm();" target="_blank" href="<?php echo base_url() . "index.php/CollectionController/PrintFromGrid/" . $CheqRet[0][$i]['CollectDate']; ?>">
                                    <button class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-print"></i></button>
                                </a> -->
                            </td>
                            <td id="" class="text-left"><?php echo $CheqRet[0][$i]['RefIDNumber']; ?></td>
                            <td id="" class="text-left"><?php echo date_format(date_create($CheqRet[0][$i]['ReturnDate']), 'd/m/y'); ?></td>
                            <td id="" class="text-left"><?php echo $CheqRet[0][$i]['CheqNo']; ?></td>
                            <td id=""><?php echo $CheqRet[0][$i]['BankCode']; ?></td>
                            <td id=""><?php echo $CheqRet[0][$i]['ACTitle']; ?></td>
                            <td id="numericCol"><?php echo $CheqRet[0][$i]['ReturnAmt']; ?></td>
                        </tr>
                <?php
                    }
                }
