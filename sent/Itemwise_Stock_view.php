    ...
    <div class="main">
        <div class="headernav">
            ...
            <div style="position:relative; margin-left:10px; margin-top:10px;">
                ...
                <form class="form" method='post'  action='<?php echo base_url() ?>index.php/TBReportController/Itemwise_Stockshow'>
                    <b style="margin-right:20px">Itemwise Stock</b>
                    ...
                    "drawCallback": function(settings) {
                        ...
                        api.column(groupColumn, {
                            ...
                            if (typeof aData[group] == 'undefined') {
                                ...
                                aData[group].rows = [];
                                subTotal[group] = new Array(4).fill(0);
