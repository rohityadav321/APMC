                ...
                <form method='post' action='<?php echo base_url() ?>index.php/ReportController/rateDiffReportFilter'>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="date" id="fromYear" name="fromYear" style="margin-right : 10px" value="<?php echo $fromyear; ?>">
                            </td>
                            <td>
                                <label>To : </label>
                            </td>
                            <td>
                                <input type="date" id="toYear" name="toYear" style="margin-right : 10px" value="<?php echo $toyear; ?>">
                            </td>
                    ...
                    <table id="filterTable">
                        ...
                        <tr>
                            <td>
                                <input type="radio" id="Brokerwise" name="filter" value="Brokerwise" checked <?php echo set_value('filter', $RTYPE[0]) == "Brokerwise" ? "checked" : ""; ?>>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <input type="radio" id="Areawise" name="filter" value="Areawise" <?php echo set_value('filter', $RTYPE[0]) == "Areawise" ? "checked" : ""; ?>>
                            </td>
                            <td>
                    ...
                    <table id="filter1Table">
                        ...
                        <tr>
                            <td>
                                <input type="radio" id="Detail" name="filter1" value="Detail" checked <?php echo set_value('filter1', $RTYPE1[0]) == "Detail" ? "checked" : ""; ?>>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <input type="radio" id="Summary" name="filter1" value="Summary" <?php echo set_value('filter1', $RTYPE1[0]) == "Summary" ? "checked" : ""; ?>>
                            </td>
                            <td>
