           ...
           <td><input 
            ...
            <td><input 
                ...
                >
                  ...
                  id="Brokerage"
                  name="Brokerage"
                  value="<?php echo set_value('Brokerage'); ?>">
                  ...
                  id="Brokamt"
                  name="Brokamt"
                  value="<?php echo set_value('Brokamt'); ?>">
              ...
              <tbody>
                ...
                <tr>
                      ...
                      <input 
                          ...
                          type="text" 
                          style="outline: none;border: none;border-color: transparent;text-align:right;"
                          value="<?php echo set_value('Code1',$SalesDList[0]->BillText1); ?>"
                          >
                      </td>
                </tr>
                ...
                <tr>
                    ...
                    <input 
                        ...
                        type="text" 
                        style="outline: none;border: none;border-color: transparent;text-align:right;"
                        value="<?php echo set_value('Code1',$SalesDList[0]->BillText2); ?>"
                        >
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <input 
                        ...
                        type="text" 
                        style="outline: none;border: none;border-color: transparent;text-align:right;"
                        value="<?php echo set_value('Code1',$SalesDList[0]->NBrokRate); ?>"
                        >
                    </td>
